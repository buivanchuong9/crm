...
//#region node_modules/react18-json-view/dist/es/index.mjs
...
function isCollapsed(node, depth, indexOrName, collapsed, collapseObjectsAfterLength, customOptions) {
	if (customOptions && customOptions.collapsed !== void 0) return !!customOptions.collapsed;
	...
	if (typeof collapsed === "function") {
		const result = safeCall(collapsed, [{
			node,
			depth,
			indexOrName,
			size
...
function editableAdd(editable) {
	...
	if (isObject(editable) && editable.add === true) return true;
}
function editableEdit(editable) {
	if (editable === true) return true;
	if (isObject(editable) && editable.edit === true) return true;
}
function editableDelete(editable) {
	if (editable === true) return true;
	if (isObject(editable) && editable.delete === true) return true;
}
...
function resolveEvalFailedNewValue(type, value) {
	if (type === "string") return value.trim().replace(/^\"([\s\S]+?)\"$/, "$1");
	return value;
}
var _path$8;
function _extends$8() {
...
var SvgAngleDown = function SvgAngleDown(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$8({
		...
		fill: "none",
		viewBox: "0 0 16 16"
	}, props), _path$8 || (_path$8 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
...
var SvgCopy = function SvgCopy(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$7({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$7 || (_path$7 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
...
var SvgCopied = function SvgCopied(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$6({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$6 || (_path$6 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
	...
	})), _path2$5 || (_path2$5 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "#14C786",
...
function CopyButton({ node, nodeMeta }) {
	...
	const copyHandler = (event) => {
		...
		if (typeof value === "string" && value) writeClipboard(value);
		setCopied(true);
		setTimeout(() => setCopied(false), 3e3);
	};
	return copied ? typeof CopiedComponent === "function" ? (0, import_jsx_runtime.jsx)(CopiedComponent, {
		className: "json-view--copy",
		style: { display: "inline-block" }
	}) : (0, import_jsx_runtime.jsx)(SvgCopied, {
		className: "json-view--copy",
		style: { display: "inline-block" }
	}) : typeof CopyComponent === "function" ? (0, import_jsx_runtime.jsx)(CopyComponent, {
		onClick: copyHandler,
		className: "json-view--copy"
	}) : (0, import_jsx_runtime.jsx)(SvgCopy, {
		onClick: copyHandler,
		className: "json-view--copy"
	});
}
function NameValue({ indexOrName, value, depth, deleteHandle, editHandle, parent, parentPath }) {
	...
	return (0, import_jsx_runtime.jsxs)("div", Object.assign({ className: "json-view--pair" }, { children: [!isArray || isArray && displayArrayIndex ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)("span", Object.assign({ className: typeof indexOrName === "number" ? "json-view--index" : "json-view--property" }, { children: indexOrName })),
		":",
		" "
	] }) : (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, {}), (0, import_jsx_runtime.jsx)(JsonNode, {
		node: value,
		depth: depth + 1,
...
var SvgTrash = function SvgTrash(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$5({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$5 || (_path$5 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
	...
	})), _path2$4 || (_path2$4 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "#DA0000",
...
var SvgAddSquare = function SvgAddSquare(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$4({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$4 || (_path$4 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
	...
	})), _path2$3 || (_path2$3 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "#14C786",
...
var SvgDone = function SvgDone(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$3({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$3 || (_path$3 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
		d: "M12 3a9 9 0 1 0 9 9 9.01 9.01 0 0 0-9-9Zm0 16.5a7.5 7.5 0 1 1 7.5-7.5 7.509 7.509 0 0 1-7.5 7.5Z"
	})), _path2$2 || (_path2$2 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "#14C786",
...
var SvgCancel = function SvgCancel(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$2({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$2 || (_path$2 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "#DA0000",
	...
	})), _path2$1 || (_path2$1 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
		d: "M12 3a9 9 0 1 0 9 9 9.01 9.01 0 0 0-9-9Zm0 16.5a7.5 7.5 0 1 1 7.5-7.5 7.509 7.509 0 0 1-7.5 7.5Z"
	})));
};
function LargeArrayNode({ originNode, node, depth, index, deleteHandle: _deleteSelf, customOptions, startIndex, parent, parentPath }) {
	...
	const Icons = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		!fold && (0, import_jsx_runtime.jsxs)("span", Object.assign({
			onClick: () => setFold(true),
			className: "jv-size-chevron"
		}, { children: [ifDisplay(displaySize, depth, fold) && (0, import_jsx_runtime.jsxs)("span", Object.assign({ className: "jv-size" }, { children: [objectSize(node), " Items"] })), (0, import_jsx_runtime.jsx)(SvgAngleDown, { className: "jv-chevron" })] })),
		!fold && enableClipboard && customCopy(customOptions) && (0, import_jsx_runtime.jsx)(CopyButton, {
			node,
			nodeMeta: {
				depth,
				indexOrName: index,
		...
		typeof CustomOperation === "function" ? (0, import_jsx_runtime.jsx)(CustomOperation, { node }) : null
	] });
	return (0, import_jsx_runtime.jsxs)("div", { children: [
		(0, import_jsx_runtime.jsx)("span", { children: "[" }),
		Icons,
		!fold ? (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "jv-indent" }, { children: node.map((n, i) => (0, import_jsx_runtime.jsx)(NameValue, {
			...
			editHandle,
			parentPath
		}, String(index) + String(i))) })) : (0, import_jsx_runtime.jsxs)("button", Object.assign({
...
function LargeArray({ node, depth, deleteHandle: _deleteSelf, indexOrName, customOptions, parent, parentPath }) {
	...
	for (let i = 0; i < node.length; i += 100) nestCollapsedArray.push(node.slice(i, i + 100));
	...
	const Icons = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		!fold && !isEditing && (0, import_jsx_runtime.jsxs)("span", Object.assign({
			onClick: () => setFold(true),
			className: "jv-size-chevron"
		}, { children: [ifDisplay(displaySize, depth, fold) && (0, import_jsx_runtime.jsxs)("span", Object.assign({ className: "jv-size" }, { children: [node.length, " Items"] })), (0, import_jsx_runtime.jsx)(SvgAngleDown, { className: "jv-chevron" })] })),
		isEditing && (0, import_jsx_runtime.jsx)(SvgDone, {
			className: "json-view--edit",
			style: { display: "inline-block" },
			onClick: adding ? add : deleteSelf
		}),
		isEditing && (0, import_jsx_runtime.jsx)(SvgCancel, {
			className: "json-view--edit",
			style: { display: "inline-block" },
			onClick: cancel
		}),
		!fold && !isEditing && enableClipboard && customCopy(customOptions) && (0, import_jsx_runtime.jsx)(CopyButton, {
			node,
			nodeMeta: {
				depth,
				indexOrName,
		...
		!fold && !isEditing && editableAdd(editable) && customAdd(customOptions) && (0, import_jsx_runtime.jsx)(SvgAddSquare, {
			className: "json-view--edit",
			onClick: () => {
				add();
			}
		}),
		!fold && !isEditing && editableDelete(editable) && customDelete(customOptions) && _deleteSelf && (0, import_jsx_runtime.jsx)(SvgTrash, {
			className: "json-view--edit",
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)("span", { children: "[" }),
		Icons,
		!fold ? (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "jv-indent" }, { children: nestCollapsedArray.map((item, index) => (0, import_jsx_runtime.jsx)(LargeArrayNode, {
			originNode: node,
			node: item,
			depth,
			index,
			...
			customOptions,
			parentPath
		}, String(indexOrName) + String(index))) })) : (0, import_jsx_runtime.jsx)("button", Object.assign({
			onClick: () => setFold(false),
			className: "jv-button"
		}, { children: "..." })),
		(0, import_jsx_runtime.jsx)("span", { children: "]" }),
		fold && ifDisplay(displaySize, depth, fold) && (0, import_jsx_runtime.jsxs)("span", Object.assign({
			onClick: () => setFold(false),
			className: "jv-size"
		}, { children: [node.length, " Items"] }))
	] });
}
function ObjectNode({ node, depth, indexOrName, deleteHandle: _deleteSelf, customOptions, parent, parentPath }) {
	...
	const currentPath = typeof indexOrName !== "undefined" ? [...parentPath, String(indexOrName)] : parentPath;
	if (!ignoreLargeArray && Array.isArray(node) && node.length > 100) return (0, import_jsx_runtime.jsx)(LargeArray, {
		node,
		depth,
		indexOrName,
		deleteHandle: _deleteSelf,
	...
	const editHandle = (0, import_react.useCallback)((indexOrName, newValue, oldValue) => {
		if (Array.isArray(node)) node[+indexOrName] = newValue;
		else if (node) node[indexOrName] = newValue;
		if (onEdit) onEdit({
			newValue,
			oldValue,
			depth,
	...
	const deleteHandle = (indexOrName) => {
		if (Array.isArray(node)) node.splice(+indexOrName, 1);
		else if (node) delete node[indexOrName];
		forceUpdate();
	};
	const [deleting, setDeleting] = (0, import_react.useState)(false);
	const deleteSelf = () => {
	...
	const Icons = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		adding && isPlainObject && (0, import_jsx_runtime.jsx)("input", {
	...
	if (Array.isArray(node)) return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)("span", { children: "[" }),
		Icons,
		!fold ? (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "jv-indent" }, { children: node.map((n, i) => (0, import_jsx_runtime.jsx)(NameValue, {
			indexOrName: i,
			...
			editHandle,
			parentPath: currentPath
		}, String(indexOrName) + String(i))) })) : (0, import_jsx_runtime.jsx)("button", Object.assign({
			onClick: () => setFold(false),
			className: "jv-button"
		}, { children: "..." })),
		(0, import_jsx_runtime.jsx)("span", { children: "]" }),
		fold && ifDisplay(displaySize, depth, fold) && (0, import_jsx_runtime.jsxs)("span", Object.assign({
			onClick: () => setFold(false),
			className: "jv-size"
		}, { children: [objectSize(node), " Items"] }))
	] });
	else if (isPlainObject) return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)("span", { children: "{" }),
		Icons,
		!fold ? (0, import_jsx_runtime.jsx)("div", Object.assign({ className: "jv-indent" }, { children: Object.entries(node).map(([name, value]) => (0, import_jsx_runtime.jsx)(NameValue, {
			indexOrName: name,
			value,
			depth,
			parent: node,
			...
			editHandle,
			parentPath: currentPath
		}, String(indexOrName) + String(name))) })) : (0, import_jsx_runtime.jsx)("button", Object.assign({
			onClick: () => setFold(false),
			className: "jv-button"
		}, { children: "..." })),
		(0, import_jsx_runtime.jsx)("span", { children: "}" }),
	...
	else return (0, import_jsx_runtime.jsx)("span", { children: String(node) });
}
var LongString = import_react.forwardRef(({ str, className, ctrlClick }, ref) => {
	...
	const clickToTruncateOrEdit = (event) => {
		var _a;
		if ((event.ctrlKey || event.metaKey) && ctrlClick) ctrlClick(event);
		else {
			const selection = window.getSelection();
			if (selection && selection.anchorOffset !== selection.focusOffset && ((_a = selection.anchorNode) === null || _a === void 0 ? void 0 : _a.parentElement) === strRef.current) return;
			setTruncated(!truncated);
		}
	};
	if (str.length <= collapseStringsAfterLength) return (0, import_jsx_runtime.jsxs)("span", Object.assign({
		ref: strRef,
		className,
		onClick: ctrlClick
	}, { children: [
	...
	if (collapseStringMode === "address") return str.length <= 10 ? (0, import_jsx_runtime.jsxs)("span", Object.assign({
		ref: strRef,
		className,
		onClick: ctrlClick
	}, { children: [
		...
		str,
		"\""
	] })) : (0, import_jsx_runtime.jsxs)("span", Object.assign({
		ref: strRef,
		onClick: clickToTruncateOrEdit,
	...
	if (collapseStringMode === "directly") return (0, import_jsx_runtime.jsxs)("span", Object.assign({
		ref: strRef,
		onClick: clickToTruncateOrEdit,
		className: className + " cursor-pointer"
	}, { children: [
	...
	if (collapseStringMode === "word") {
		...
		return (0, import_jsx_runtime.jsxs)("span", Object.assign({
			ref: strRef,
			onClick: clickToTruncateOrEdit,
			className: className + " cursor-pointer"
		}, { children: [
...
var SvgEdit = function SvgEdit(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends$1({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path$1 || (_path$1 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
...
var SvgLink = function SvgLink(props) {
	return /* @__PURE__ */ import_react.createElement("svg", _extends({
		...
		fill: "none",
		viewBox: "0 0 24 24"
	}, props), _path || (_path = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
	...
	})), _path2 || (_path2 = /* @__PURE__ */ import_react.createElement("path", {
		fill: "currentColor",
...
function JsonNode({ node, depth, deleteHandle: _deleteHandle, indexOrName, parent, editHandle, parentPath }) {
	...
	let customReturn;
	if (typeof customizeNode === "function") customReturn = safeCall(customizeNode, [{
		node,
		depth,
		indexOrName
	}]);
	if (customReturn) {
		if ((0, import_react.isValidElement)(customReturn)) return customReturn;
		else if (isReactComponent(customReturn)) return (0, import_jsx_runtime.jsx)(customReturn, {
			node,
			depth,
			indexOrName
		});
	}
	if (Array.isArray(node) || isObject(node)) return (0, import_jsx_runtime.jsx)(ObjectNode, {
		parent,
		node,
		depth,
		indexOrName,
		...
		const edit = () => {
			...
			setTimeout(() => {
				var _a, _b;
				(_a = window.getSelection()) === null || _a === void 0 || _a.selectAllChildren(valueRef.current);
				(_b = valueRef.current) === null || _b === void 0 || _b.focus();
			});
		};
		...
		const Icons = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			isEditing && (typeof DoneComponent === "function" ? (0, import_jsx_runtime.jsx)(DoneComponent, {
				className: "json-view--edit",
				style: { display: "inline-block" },
				onClick: deleting ? deleteHandle : done
			}) : (0, import_jsx_runtime.jsx)(SvgDone, {
				className: "json-view--edit",
				style: { display: "inline-block" },
				onClick: deleting ? deleteHandle : done
			})),
			isEditing && (typeof CancelComponent === "function" ? (0, import_jsx_runtime.jsx)(CancelComponent, {
				className: "json-view--edit",
				style: { display: "inline-block" },
				onClick: cancel
			}) : (0, import_jsx_runtime.jsx)(SvgCancel, {
				className: "json-view--edit",
				style: { display: "inline-block" },
				onClick: cancel
			})),
			!isEditing && enableClipboard && customCopy(customReturn) && (0, import_jsx_runtime.jsx)(CopyButton, {
				node,
				nodeMeta: {
					depth,
					indexOrName,
			...
			!isEditing && matchesURL && type === "string" && urlRegExp.test(node) && customMatchesURL(customReturn) && (0, import_jsx_runtime.jsx)("a", Object.assign({
				href: node,
				target: "_blank",
				className: "json-view--link"
			}, { children: (0, import_jsx_runtime.jsx)(SvgLink, {}) })),
			!isEditing && editableEdit(editable) && customEdit(customReturn) && editHandle && (typeof EditComponent === "function" ? (0, import_jsx_runtime.jsx)(EditComponent, {
				className: "json-view--edit",
				onClick: edit
			}) : (0, import_jsx_runtime.jsx)(SvgEdit, {
				className: "json-view--edit",
				onClick: edit
			})),
			!isEditing && editableDelete(editable) && customDelete(customReturn) && _deleteHandle && (0, import_jsx_runtime.jsx)(SvgTrash, {
				className: "json-view--edit",
				onClick: () => setDeleting(true)
			}),
			typeof CustomOperation === "function" ? (0, import_jsx_runtime.jsx)(CustomOperation, { node }) : null
		...
		if (typeof (customReturn === null || customReturn === void 0 ? void 0 : customReturn.className) === "string") className += " " + customReturn.className;
		if (deleting) className += " json-view--deleting";
		let displayValue = String(node);
		if (type === "bigint") displayValue += "n";
		const EditingElement = (0, import_react.useMemo)(() => (0, import_jsx_runtime.jsx)("span", {
		...
		if (type === "string") return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [editing ? EditingElement : node.length > collapseStringsAfterLength ? (0, import_jsx_runtime.jsx)(LongString, {
			str: node,
			ref: valueRef,
			className,
			ctrlClick
		...
		else return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [editing ? EditingElement : (0, import_jsx_runtime.jsx)("span", Object.assign({
			className,
			onClick: ctrlClick
		}, { children: displayValue })), Icons] });
	}
}
...
function JsonView({ src: _src, collapseStringsAfterLength = 99, collapseStringMode = "directly", customizeCollapseStringUI, collapseObjectsAfterLength = 99, collapsed, onCollapse, enableClipboard = true, editable = false, onEdit, onDelete, onAdd, onChange, dark = false, theme = "default", customizeNode, customizeCopy = (node) => stringifyForCopying(node), displaySize, displayArrayIndex = true, style, className, matchesURL = false, urlRegExp = defaultURLRegExp, ignoreLargeArray = false, CopyComponent, CopiedComponent, EditComponent, CancelComponent, DoneComponent, CustomOperation }) {
	...
	return (0, import_jsx_runtime.jsx)(JsonViewContext.Provider, Object.assign({ value: {
		...
		DoneComponent,
		CustomOperation
	} }, { children: (0, import_jsx_runtime.jsx)("code", Object.assign({
		className: "json-view" + (dark ? " dark" : "") + (theme && theme !== "default" ? " json-view_" + theme : "") + (className ? " " + className : ""),
		style
	}, { children: (0, import_jsx_runtime.jsx)(JsonNode, {
		node: src,
		depth: 1,
