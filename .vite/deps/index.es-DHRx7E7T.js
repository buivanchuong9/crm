...
import { $n as Facet, $t as FeelersEditor, A as FormFields, At as getSchemaVariables, Bn as keymap, C as FieldFactory, Cn as foldInside, Ct as createInjector, D as FormContext, Dn as indentOnInput, E as FormComponent, En as indentNodeProp, F as IFrame, G as OPTIONS_SOURCES_DEFAULTS, H as MarkdownRendererModule, Hn as placeholder, K as OPTIONS_SOURCES_LABELS, L as Importer, M as FormRenderContext, Nt as iconsByType, On as syntaxHighlighting, Ot as getAncestryList, P as Html, Qn as EditorState, R as Label$3, St as createFormContainer, Tn as foldNodeProp, Vn as lineNumbers, W as OPTIONS_SOURCES, Wt as sanitizeImageSource, Xn as Compartment, Y as PathRegistry, _ as ExpressionField, _n as LanguageSupport, _r as Big, an as defaultKeymap, at as TEXT_VIEW_DEFAULT_TEXT, bt as clone, c as DATETIME_SUBTYPE_PATH, ct as TIME_SERIALISINGFORMAT_LABELS, dt as TIME_USE24H_PATH, en as cmFeelLinter, fn as completeFromList, fr as tags, ft as Table, gn as LRLanguage, gr as o, hn as HighlightStyle, hr as z$1, in as setDiagnosticsEffect, j as FormLayouter, jn as EditorView, jt as getScrollContainer, k as FormFieldRegistry$1, kn as syntaxTree, kt as getOptionsSource, l as DATE_DISALLOW_PAST_PATH, ln as autocompletion, lr as parser, lt as TIME_SERIALISING_FORMATS, m as DocumentPreview, mn as snippetCompletion$1, mr as k, mt as Text$1, o as DATETIME_SUBTYPES, ot as TIME_INTERVAL_PATH, q as OPTIONS_SOURCES_PATHS, qn as tooltips, rn as linter$1, s as DATETIME_SUBTYPES_LABELS, st as TIME_LABEL_PATH, tt as SECURITY_ATTRIBUTES_DEFINITIONS, u as DATE_LABEL_PATH, un as closeBrackets, ur as trackVariables, ut as TIME_SERIALISING_FORMAT_PATH, vn as bracketMatching, vr as Ids, x as FeelExpressionLanguage, xn as delimitedIndent, yn as continuedIndent, zt as runRecursively } from "./index.es-CMvMby7r.js";
...
import { Fragment as k$1, createContext as G, createElement as y, render as D } from "./preact.js";
import { useCallback as T$1, useContext as q, useEffect as p, useLayoutEffect as y$1, useMemo as F, useRef as _, useState as h } from "./preact_hooks.js";
import { a as tabbable, i as isTabbable, n as getTabIndex, r as isFocusable, t as focusable } from "./index.esm-Be-FLYTC.js";
...
var Slot = (props) => {
	...
	return o(k$1, { children: [fillsAndSeparators, managerFills.map((fill) => o(FillContainer, { fill }, fill.fillId))] });
};
/**
...
*/
var FillFragment = (fill) => o(k$1, { children: fill.children }, fill.id);
/**
...
var InjectedRendersRoot = () => {
	...
	return o(k$1, { children: injectedRenderers.map(({ Renderer }, index) => o(Renderer, { ...injectedProps }, index)) });
};
...
var TemplatingEditor = k((props, ref) => {
...
var OptionalFeelInput = k((props, ref) => {
...
var OptionalFeelNumberField = k((props, ref) => {
...
var OptionalFeelToggleSwitch = k((props, ref) => {
...
function Title(props) {
	...
	return o("div", {
		...
		...rest,
		children: [
			draggable && o(k$1, { children: [o("div", {
				ref: dragPreviewRef,
...
function FeelPopup$1(props) {
	...
	return o(Popup, {
		...
		children: [o(Popup.Title, {
			...
			onClose,
			draggable: true,
			children: o(k$1, { children: (links || []).map((link, index) => {
				return o("a", {
					rel: "noreferrer",
					href: link.href,
					target: "_blank",
...
var description$3 = o(k$1, { children: [
...
var description$2 = o(k$1, { children: [
...
var description$1 = o(k$1, { children: [
...
var description = o(k$1, { children: "Documents with height that exceeds the defined value will be vertically scrollable" });
...
function getTooltip() {
	return o(k$1, { children: o("p", { children: [
...
//#endregion
export { useService as a, mitt_default as c, usePrevious$1 as i, classes as l, createFormEditor as n, useService$1 as o, useDebounce$1 as r, useVariables as s, FormEditor as t, domify as u };

//# sourceMappingURL=index.es-DHRx7E7T.js.map