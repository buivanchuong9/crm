...
//#region node_modules/highcharts/modules/exporting.js
var require_exporting = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(a) {
		...
		function g(a, e, r, t) {
			a.hasOwnProperty(e) || (a[e] = t.apply(null, r));
		}
		a = a ? a._modules : {};
		g(a, "Extensions/FullScreen.js", [
			...
			t = function() {
				...
				a.prototype.open = function() {
					...
					if (d.browserProps) {
						var k = l(a.container.ownerDocument, d.browserProps.fullscreenChange, function() {
				...
				a.prototype.setButtonText = function() {
					var d = this.chart, a = d.exportDivElements, b = d.options.exporting, k = b && b.buttons && b.buttons.contextButton.menuItems;
					d = d.options.lang;
					b && b.menuItemDefinitions && d && d.exitFullscreen && d.viewFullscreen && k && a && (a = a[k.indexOf("viewFullscreen")]) && r.setElementHTML(a, this.isOpen ? d.exitFullscreen : b.menuItemDefinitions.viewFullscreen.text || d.viewFullscreen);
				};
		...
		g(a, "Extensions/Exporting/ExportingSymbols.js", [], function() {
			...
			(function(a) {
				...
				function l(a, d, e, b) {
					a = b / 3 - 2;
					b = [];
					return b = b.concat(this.circle(e - a, d, a, a), this.circle(e - a, d + a + 4, a, a), this.circle(e - a, d + 2 * (a + 4), a, a));
				}
				var g = [];
				a.compose = function(a) {
		...
		g(a, "Extensions/Exporting/Exporting.js", [
			...
			a["Core/Utilities.js"]
		], function(a, e, g, t, z, k, d, J, b) {
			e = t.defaultOptions;
			var l = d.doc, r = d.win, x = b.addEvent, q = b.css, E = b.createElement, K = b.discardElement, F = b.extend, P = b.find, G = b.fireEvent, Q = b.isObject, m = b.merge, L = b.objectEach, w = b.pick, R = b.removeEvent, S = b.uniqueKey, H;
			(function(e) {
				function t(a) {
					var c = this, d = c.renderer, b = m(c.options.navigation.buttonOptions, a), e = b.onclick, B = b.menuItems, n = b.symbolSize || 12;
					c.btnCount || (c.btnCount = 0);
					c.exportDivElements || (c.exportDivElements = [], c.exportSVGElements = []);
					if (!1 !== b.enabled && b.theme) {
						var f = b.theme, C = f.states, l = C && C.hover;
						C = C && C.select;
						var D;
						c.styledMode || (f.fill = w(f.fill, "#ffffff"), f.stroke = w(f.stroke, "none"));
						delete f.states;
						e ? D = function(a) {
							a && a.stopPropagation();
							e.call(c, a);
							...
							a && a.stopPropagation();
							c.contextMenu(p.menuClassName, B, p.translateX, p.translateY, p.width, p.height, p);
							p.setState(2);
						});
						b.text && b.symbol ? f.paddingLeft = w(f.paddingLeft, 30) : b.text || F(f, {
							width: b.width,
							height: b.height,
							padding: 0
						});
						c.styledMode || (f["stroke-linecap"] = "round", f.fill = w(f.fill, "#ffffff"), f.stroke = w(f.stroke, "none"));
						var p = d.button(b.text, 0, 0, D, f, l, C).addClass(a.className).attr({ title: w(c.options.lang[b._titleKey || b.titleKey], "") });
						p.menuClassName = a.menuClassName || "highcharts-menu-" + c.btnCount++;
						if (b.symbol) {
							var g = d.symbol(b.symbol, b.symbolX - n / 2, b.symbolY - n / 2, n, n, {
								width: n,
								height: n
							}).addClass("highcharts-button-symbol").attr({ zIndex: 1 }).add(p);
							c.styledMode || g.attr({
						...
						p.add(c.exportingGroup).align(F(b, {
							width: p.width,
							x: w(b.x, c.buttonOffset)
						}), !0, "spacingBox");
						c.buttonOffset += (p.width + b.buttonSpacing) * ("right" === b.align ? -1 : 1);
						c.exportSVGElements.push(p, g);
					}
				}
				function z() {
					if (this.printReverseInfo) {
						var a = this.printReverseInfo, b = a.childNodes, d = a.origDisplay;
						a = a.resetParams;
				...
				function H() {
					var a = l.body, b = this.options.exporting.printMaxWidth, d = {
					...
					G(this, "beforePrint");
					b && this.chartWidth > b && (d.resetParams = [
				...
				function U(c, d, e, y, g, B, n) {
					var f = this, u = f.options.navigation, A = f.chartWidth, D = f.chartHeight, p = "cache-" + c, v = Math.max(g, B), h = f[p];
					if (!h) {
						f.exportContextMenu = f[p] = h = E("div", { className: c }, {
							position: "absolute",
							zIndex: 1e3,
							padding: v + "px",
							pointerEvents: "auto"
						}, f.fixedDiv || f.container);
						var m = E("ul", { className: "highcharts-menu" }, {
							listStyle: "none",
							margin: 0,
							padding: 0
						}, h);
					...
					d = { display: "block" };
					e + f.exportMenuWidth > A ? d.right = A - e - g - v + "px" : d.left = e - v + "px";
					y + B + f.exportMenuHeight > D && "top" !== n.alignOptions.verticalAlign ? d.bottom = D - y - v + "px" : d.top = y + B - v + "px";
					q(h, d);
				...
				function V(a) {
					...
					e && (e.forEach(function(a, c) {
						a && (b.clearTimeout(a.hideTimer), R(a, "mouseleave"), e[c] = a.onmouseout = a.onmouseover = a.ontouchstart = a.onclick = null, K(a));
					}), e.length = 0);
				...
				function Z(a) {
					...
					}, l.body), e = this.renderTo.style.width;
					...
					this.axes.forEach(function(a) {
						a.userOptions.internalKey || (a.userOptions.internalKey = S());
				...
				function aa(a, b) {
					...
					return this.getSVG(m({ chart: { borderRadius: 0 } }, c.chartOptions, b, { exporting: {
				...
				function ba() {
					function a(c) {
						function e(a, d) {
							u = l = !1;
							if (g.length) {
								for (k = g.length; k-- && !l;) l = g[k].test(d);
								u = !l;
							}
							"transform" === d && "none" === a && (u = !0);
							for (k = b.length; k-- && !u;) u = b[k].test(d) || "function" === typeof a;
							u || q[d] === a && "svg" !== c.nodeName || y[c.nodeName][d] === a || (N && -1 === N.indexOf(d) ? f += M(d) + ":" + a + ";" : a && c.setAttribute(M(d), a));
						}
						var f = "", u, l, k;
						if (1 === c.nodeType && -1 === ca.indexOf(c.nodeName)) {
							var h = r.getComputedStyle(c, null);
							var q = "svg" === c.nodeName ? {} : r.getComputedStyle(c.parentNode, null);
							if (!y[c.nodeName]) {
								v = n.getElementsByTagName("svg")[0];
								var A = n.createElementNS(c.namespaceURI, c.nodeName);
								v.appendChild(A);
								y[c.nodeName] = m(r.getComputedStyle(A, null));
								"text" === c.nodeName && delete y.text.fill;
								v.removeChild(A);
							}
							if (d.isFirefox || d.isMS) for (var t in h) e(h[t], t);
							else L(h, e);
					...
					var b = da, g = e.inlineWhitelist, y = {}, v, k = l.createElement("iframe");
					q(k, {
						width: "1px",
						height: "1px",
						visibility: "hidden"
					...
					var n = k.contentWindow.document;
					n.open();
				...
				function fa() {
					var a = this;
					a.exporting = { update: function(c, b) {
				...
				function ia() {
					var a = this, b = a.options.exporting, d = b.buttons, e = a.isDirtyExporting || !a.exportSVGElements;
					a.buttonOffset = 0;
					a.isDirtyExporting && a.destroyExport();
					e && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({ zIndex: 3 }).add(), L(d, function(b) {
						a.addButton(b);
				...
				e.compose = function(a, b) {
					k.compose(b);
					-1 === O.indexOf(a) && (O.push(a), b = a.prototype, b.afterPrint = z, b.exportChart = W, b.inlineStyles = ba, b.print = ha, b.sanitizeSVG = ja, b.getChartHTML = X, b.getSVG = Z, b.getSVGForExport = aa, b.getFilename = Y, b.moveContainers = ea, b.beforePrint = H, b.contextMenu = U, b.addButton = t, b.destroyExport = V, b.renderExporting = ia, b.callbacks.push(T), x(a, "init", fa), d.isSafari && d.win.matchMedia("print").addListener(function(a) {
						I && (a.matches ? I.beforePrint() : I.afterPrint());
					}));
				};
			})(H || (H = {}));
			e.exporting = m(z.exporting, e.exporting);
			e.lang = m(z.lang, e.lang);
			e.navigation = m(z.navigation, e.navigation);
			return H;
		});
		g(a, "masters/modules/exporting.src.js", [
			a["Core/Globals.js"],
