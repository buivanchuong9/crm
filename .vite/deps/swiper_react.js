...
import { T as Swiper$1 } from "./swiper.esm-BKZGVc9A.js";
//#region node_modules/swiper/react/utils.js
...
//#endregion
//#region node_modules/swiper/react/params-list.js
var paramsList = [
	"modules",
	"init",
	"_direction",
...
//#endregion
//#region node_modules/swiper/react/get-params.js
function getParams(obj = {}) {
	...
	Object.keys(obj).forEach((key) => {
		...
		else if (key.search(/on[A-Z]/) === 0 && typeof obj[key] === "function") events[`${key[2].toLowerCase()}${key.substr(3)}`] = obj[key];
...
//#endregion
//#region node_modules/swiper/react/init-swiper.js
...
//#endregion
//#region node_modules/swiper/react/loop.js
function calcLoopedSlides(slides, swiperParams) {
	...
	if (swiperParams.breakpoints) {
		...
		if (breakpointOnlyParams && breakpointOnlyParams.slidesPerView) slidesPerViewParams = breakpointOnlyParams.slidesPerView;
	}
	let loopedSlides = Math.ceil(parseFloat(swiperParams.loopedSlides || slidesPerViewParams, 10));
	loopedSlides += swiperParams.loopAdditionalSlides;
	if (loopedSlides > slides.length) loopedSlides = slides.length;
	return loopedSlides;
}
function renderLoop(swiper, slides, swiperParams) {
	...
	if (swiperParams.loopFillGroupWithBlank) {
		...
		if (blankSlidesNum !== swiperParams.slidesPerGroup) for (let i = 0; i < blankSlidesNum; i += 1) {
			const blankSlide = /* @__PURE__ */ import_react.createElement("div", { className: `${swiperParams.slideClass} ${swiperParams.slideBlankClass}` });
			modifiedSlides.push(blankSlide);
		}
	}
	if (swiperParams.slidesPerView === "auto" && !swiperParams.loopedSlides) swiperParams.loopedSlides = modifiedSlides.length;
	const loopedSlides = calcLoopedSlides(modifiedSlides, swiperParams);
	const prependSlides = [];
	const appendSlides = [];
	modifiedSlides.forEach((child, index) => {
		if (index < loopedSlides) appendSlides.push(duplicateSlide(child, index, "prepend"));
		if (index < modifiedSlides.length && index >= modifiedSlides.length - loopedSlides) prependSlides.push(duplicateSlide(child, index, "append"));
	});
	if (swiper) swiper.loopedSlides = loopedSlides;
	return [
		...prependSlides,
		...modifiedSlides,
		...appendSlides
...
//#endregion
//#region node_modules/swiper/react/get-changed-params.js
...
//#endregion
//#region node_modules/swiper/react/get-children.js
function processChildren(c) {
	const slides = [];
	import_react.Children.toArray(c).forEach((child) => {
		if (child.type && child.type.displayName === "SwiperSlide") slides.push(child);
...
//#endregion
//#region node_modules/swiper/react/update-swiper.js
function updateSwiper({ swiper, slides, passedParams, changedParams, nextEl, prevEl, scrollbarEl, paginationEl }) {
	...
	if (changedParams.includes("thumbs") && passedParams.thumbs && passedParams.thumbs.swiper && currentParams.thumbs && !currentParams.thumbs.swiper) needThumbsInit = true;
	...
	updateParams.forEach((key) => {
		if (isObject(currentParams[key]) && isObject(passedParams[key])) extend(currentParams[key], passedParams[key]);
		else {
	...
	if (changedParams.includes("children") && virtual && currentParams.virtual.enabled) {
		...
		virtual.update(true);
	} else if (changedParams.includes("children") && swiper.lazy && swiper.params.lazy.enabled) swiper.lazy.load();
	if (needThumbsInit) {
...
//#endregion
//#region node_modules/swiper/react/virtual.js
...
//#endregion
//#region node_modules/swiper/react/use-isomorphic-layout-effect.js
...
//#endregion
//#region node_modules/swiper/react/swiper.js
function _extends$1() {
...
var Swiper = /* @__PURE__ */ (0, import_react.forwardRef)(({ className, tag: Tag = "div", wrapperTag: WrapperTag = "div", children, onSwiper, ...rest } = {}, externalElRef) => {
	...
	if (!swiperElRef.current) {
		...
		if (swiperParams.loop) swiperRef.current.loopedSlides = calcLoopedSlides(slides, swiperParams);
	...
	function renderSlides() {
		...
		if (!swiperParams.loop || swiperRef.current && swiperRef.current.destroyed) return slides.map((child) => {
			return /* @__PURE__ */ import_react.cloneElement(child, { swiper: swiperRef.current });
		});
		return renderLoop(swiperRef.current, slides, swiperParams);
	}
	return /* @__PURE__ */ import_react.createElement(Tag, _extends$1({
		ref: swiperElRef,
		className: uniqueClasses(`${containerClasses}${className ? ` ${className}` : ""}`)
	}, restProps), slots["container-start"], needsNavigation(swiperParams) && /* @__PURE__ */ import_react.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.createElement("div", {
		ref: prevElRef,
	...
	}), /* @__PURE__ */ import_react.createElement(WrapperTag, { className: "swiper-wrapper" }, slots["wrapper-start"], renderSlides(), slots["wrapper-end"]), slots["container-end"]);
});
Swiper.displayName = "Swiper";
//#endregion
//#region node_modules/swiper/react/swiper-slide.js
function _extends() {
...
var SwiperSlide = /* @__PURE__ */ (0, import_react.forwardRef)(({ tag: Tag = "div", children, className = "", swiper, zoom, virtualIndex, ...rest } = {}, externalRef) => {
	...
	useIsomorphicLayoutEffect(() => {
		if (swiper && slideElRef.current) setSlideClasses(swiper.getSlideClasses(slideElRef.current));
	}, [swiper]);
	let slideData;
	if (typeof children === "function") slideData = {
	...
	}, rest), zoom ? /* @__PURE__ */ import_react.createElement("div", {
...
//#endregion
//#region node_modules/swiper/react/swiper-react.js
/**
* Swiper React 7.4.1
