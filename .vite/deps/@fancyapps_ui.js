//#region node_modules/@fancyapps/ui/dist/index.esm.js
var t = (t, e = 1e4) => (t = parseFloat(t + "") || 0, Math.round((t + Number.EPSILON) * e) / e), e = function(t) {
...
var d = (t) => "object" == typeof t && null !== t && t.constructor === Object && "[object Object]" === Object.prototype.toString.call(t), u = (t, ...e) => {
	const i = e.length;
	for (let n = 0; n < i; n++) {
		const i = e[n] || {};
...
var f = class {
	...
	on(t, e) {
		let i = [];
		"string" == typeof t ? i = t.split(" ") : Array.isArray(t) && (i = t), this.events || (this.events = /* @__PURE__ */ new Map()), i.forEach(((t) => {
...
var I = class I extends g {
	...
	attachEvents() {
		...
		t.addEventListener("click", this.onClick, {
			passive: !1,
			capture: !1
		}), t.addEventListener("wheel", this.onWheel, { passive: !1 }), this.pointerTracker = new l(t, {
	...
	checkBounds(t = 0, e = 0) {
		...
		let u = 0, p = 0;
		return l !== Infinity && n < l ? u = l - n : c !== Infinity && n > c && (u = c - n), h !== Infinity && s < h ? p = h - s : d !== Infinity && s > d && (p = d - s), Math.abs(u) < 1e-4 && (u = 0), Math.abs(p) < 1e-4 && (p = 0), Object.assign(Object.assign({}, o), {
			xDiff: u,
			yDiff: p,
			inBounds: !u && !p
		});
	...
	clampTargetBounds() {
		...
		e.min !== Infinity && (t.e = Math.max(t.e, e.min)), e.max !== Infinity && (t.e = Math.min(t.e, e.max)), i.min !== Infinity && (t.f = Math.max(t.f, i.min)), i.max !== Infinity && (t.f = Math.min(t.f, i.max));
	}
	...
	setEdgeForce() {
		...
		0 !== n ? (this.isBouncingX = !0, n * a <= 0 ? a += .14 * n : (a = .14 * n, e.min !== Infinity && (this.target.e = Math.max(t.e, e.min)), e.max !== Infinity && (this.target.e = Math.min(t.e, e.max))), o && (a = Math.max(Math.min(a, o), -1 * o))) : this.isBouncingX = !1, 0 !== s ? (this.isBouncingY = !0, s * r <= 0 ? r += .14 * s : (r = .14 * s, i.min !== Infinity && (this.target.f = Math.max(t.f, i.min)), i.max !== Infinity && (this.target.f = Math.min(t.f, i.max))), o && (r = Math.max(Math.min(r, o), -1 * o))) : this.isBouncingY = !1, this.isBouncingX && (this.velocity.e = a), this.isBouncingY && (this.velocity.f = r);
	}
	enable() {
	...
	calculateBounds() {
		...
		if (!0 === d || s && d === s) r = -Infinity, c = Infinity, l = -Infinity, h = Infinity;
		else {
	...
	zoomWithWheel(e) {
		...
		t(l) < t(r) && t(o) <= t(r) ? (this.cwd += Math.abs(s), l = r) : t(l) > t(a) && t(o) >= t(a) ? (this.cwd += Math.abs(s), l = a) : (this.cwd = 0, l = Math.max(Math.min(l, a), r)), this.cwd > this.option("wheelLimit") || (e.preventDefault(), t(l) !== t(o) && this.zoomTo(l, { event: e }));
	}
	canZoomIn() {
...
var Q = class Q extends g {
	...
	createPages() {
		...
		n = ("auto" === n || e <= i) && !1 !== this.option("fill") ? Infinity : parseFloat(n + "");
		let s = 0, o = 0, a = 0;
	...
	getSlideMetrics(e) {
		...
		if (r ? o = parseFloat(r.dataset[s] || "") || 0 : (r = document.createElement("div"), r.style.visibility = "hidden", (this.track || document.body).prepend(r)), P(r, this.cn(J) + " " + e.class + " " + e.customClass), o) r.style[s] = `${o}px`, r.style["width" === s ? "height" : "width"] = "";
		else {
	...
	manageSlideVisiblity() {
		const t = /* @__PURE__ */ new Set(), e = /* @__PURE__ */ new Set(), i = this.getVisibleSlides(parseFloat(this.option("preload", 0) + "") || 0);
	...
	onAnimationEnd(t) {
		...
		a && o.substring(0, a.length + 2) === `f-${a}` && this.inTransition.delete(n), this.inTransition.size || this.clearTransitions(), n === this.page && !(null === (e = this.panzoom) || void 0 === e) && e.isResting && this.emit("settle");
	}
...
var wt = class extends _ {
	...
	process(t, e) {
		return new Promise(((i, s) => {
			...
			t.panzoom = new I(r, u({ transformParent: !0 }, this.option("Panzoom") || {}, {
				content: l,
	...
	zoomIn(t) {
		return new Promise(((e, i) => {
			...
			const g = { event: "mousemove" === o.panMode ? n.prevMouseMoveEvent || n.options.event : void 0 }, m = this.optionFor(t, "initialSize");
...
var xt = "html", Et = "image", St = "map", Pt = "youtube", Ct = "vimeo", Tt = "html5video", Mt = (t, e = {}) => {
	...
	setContent(t) {
		...
		if (t && t.type && e) {
			switch (t.type) {
				...
				case Pt:
				case Ct: t.preload = !1;
				case "iframe": this.setIframeContent(t);
			}
...
var It = class extends _ {
	...
	onMouseLeave() {
		var t;
		this.inHover = !1, !(null === (t = this.instance.panzoom) || void 0 === t) && t.isResting && this.resume();
	}
	onTimerEnd() {
...
var Dt = class extends _ {
	...
	onPrepare(t) {
		...
		if (!e) return;
		const i = t.container;
		i && (e.options.Autoplay = u({ autoStart: !1 }, this.option("Autoplay") || {}, {
			pauseOnHover: !1,
			...
			on: {
				...
				resume: (e, i) => {
					var n, s, o;
					!i || !i.cancelable || (null === (n = t.getSlide()) || void 0 === n ? void 0 : n.state) === lt.Ready && !(null === (o = null === (s = t.carousel) || void 0 === s ? void 0 : s.panzoom) || void 0 === o) && o.isResting || i.preventDefault();
				}
			}
...
var Bt = "isResting", Ht = "thumbWidth", Nt = "thumbHeight", _t = "thumbClipWidth";
var $t = class extends _ {
	...
	getThumb(t) {
		...
		return { html: this.instance.localize(e, [
			["%i", t.index],
			["%d", t.index + 1],
...
var Qt = class extends _ {
	...
	onClick(t) {
		...
		if (void 0 !== r.fancyboxToggleSlideshow) {
			...
			let s = e.isActive;
			o && "mousemove" === o.panMode && !s && o.reset(), s ? e.stop() : e.start();
			return;
		}
...
var ye, we = null, xe = null, Ee = 0, Se = 0, Pe = 0, Ce = 0;
var Te = /* @__PURE__ */ new Map();
var Me = 0;
var Oe = class Oe extends g {
	get isIdle() {
		return this.idle;
	}
	get isCompact() {
	...
	initLayout() {
		...
		if (s) {
			...
			})), this.option("closeExisting")) for (const t of Te.values()) t.id !== this.id && t.close();
			else this.option("animated") && (P(s, re), setTimeout((() => {
	...
	initCarousel(t) {
		...
		s.on("*", ((t, e, ...i) => {
			...
			var t, e;
			this.isCompact || this.endIdle(), !(null === (t = document.activeElement) || void 0 === t) && t.closest(".f-thumbs") && (null === (e = this.container) || void 0 === e || e.focus());
		})), s.on("settle", (() => {
	...
	hideLoading(t) {
		...
		if (!e) return;
		const i = t.spinnerEl;
		this.isClosing() ? i?.remove() : (S(e, ce), i && this.animate(i, "f-fadeOut", (() => {
			i.remove();
	...
	setIdle(t = !1) {
		...
		if (this.clearIdle(), !this.isClosing()) if (t) e();
		else {
	...
	static bind(t, e, i) {
		...
		s = s || "[data-fancybox]";
		const a = Oe.openers.get(n) || /* @__PURE__ */ new Map();
	...
	static fromEvent(t) {
		...
		if (i) {
			...
			e = document.querySelectorAll(`[data-fancybox="${t}"]`)[parseInt(i.dataset.fancyboxIndex || "", 10) || 0] || e;
		}
...
//#endregion
export { Q as Carousel, Oe as Fancybox, I as Panzoom };
