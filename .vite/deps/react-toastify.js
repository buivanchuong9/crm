...
//#endregion
//#region node_modules/react-toastify/dist/react-toastify.esm.js
...
function cssTransition(_ref) {
	...
	return function ToastTransition(_ref2) {
		...
		var animationStep = (0, import_react.useRef)(0);
		...
		return import_react.createElement(import_react.default.Fragment, null, children);
	};
}
var eventManager = {
...
function useToastContainer(props) {
	var forceUpdate = (0, import_react.useReducer)(function(x) {
		return x + 1;
	}, 0)[1];
	...
	function clearWaitingQueue(_ref) {
		...
		if (instance.props.limit && (!containerId || instance.containerId === containerId)) {
	...
	*/
	...
	function buildToast(content, _ref2) {
		...
		if (options.closeButton === false || canBeRendered(options.closeButton)) toastProps.closeButton = options.closeButton;
		else if (options.closeButton === true) toastProps.closeButton = canBeRendered(props.closeButton) ? props.closeButton : true;
		var toastContent = content;
		if ((0, import_react.isValidElement)(content) && !isStr(content.type)) toastContent = (0, import_react.cloneElement)(content, {
			closeToast,
			toastProps,
			data
		});
		...
		if (props.limit && props.limit > 0 && instance.count > props.limit && isNotAnUpdate) instance.queue.push({
			toastContent,
			toastProps,
			staleId
		});
...
function useToast(props) {
	...
	(0, import_react.useEffect)(function() {
		if (toastRef.current) toastRef.current.addEventListener("d", playToast, { once: true });
		if (isFn(props.onOpen)) props.onOpen((0, import_react.isValidElement)(props.children) && props.children.props);
		return function() {
			var props = syncProps.current;
			if (isFn(props.onClose)) props.onClose((0, import_react.isValidElement)(props.children) && props.children.props);
		};
	}, []);
	(0, import_react.useEffect)(function() {
...
function ProgressBar(_ref) {
	...
	var defaultClassName = clsx("Toastify__progress-bar", controlledProgress ? "Toastify__progress-bar--controlled" : "Toastify__progress-bar--animated", "Toastify__progress-bar-theme--" + theme, "Toastify__progress-bar--" + type, (_cx = {}, _cx["Toastify__progress-bar--rtl"] = rtl, _cx));
...
function Warning(props) {
	return (0, import_react.createElement)(Svg, Object.assign({}, props), (0, import_react.createElement)("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}
function Info(props) {
	return (0, import_react.createElement)(Svg, Object.assign({}, props), (0, import_react.createElement)("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}
function Success(props) {
	return (0, import_react.createElement)(Svg, Object.assign({}, props), (0, import_react.createElement)("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}
function Error(props) {
	return (0, import_react.createElement)(Svg, Object.assign({}, props), (0, import_react.createElement)("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}
function Spinner() {
	return (0, import_react.createElement)("div", { className: "Toastify__spinner" });
}
var Icons = {
	info: Info,
	warning: Warning,
...
var Toast = function Toast(props) {
	...
	var defaultClassName = clsx("Toastify__toast", "Toastify__toast-theme--" + theme, "Toastify__toast--" + type, (_cx = {}, _cx["Toastify__toast--rtl"] = rtl, _cx));
	...
	else if ((0, import_react.isValidElement)(icon)) Icon = (0, import_react.cloneElement)(icon, iconProps);
	...
	function renderCloseButton(closeButton) {
		...
		if ((0, import_react.isValidElement)(closeButton)) return (0, import_react.cloneElement)(closeButton, props);
	}
	return (0, import_react.createElement)(Transition, {
		...
		style,
		ref: toastRef
	}), (0, import_react.createElement)("div", Object.assign({}, isIn && { role }, {
		className: isFn(bodyClassName) ? bodyClassName({ type }) : clsx("Toastify__toast-body", bodyClassName),
		style: bodyStyle
	}), Icon && (0, import_react.createElement)("div", { className: clsx("Toastify__toast-icon", (_cx2 = {}, _cx2["Toastify--animate-icon Toastify__zoom-enter"] = !isLoading, _cx2)) }, Icon), (0, import_react.createElement)("div", null, children)), renderCloseButton(closeButton), (autoClose || isProgressControlled) && (0, import_react.createElement)(ProgressBar, Object.assign({}, updateId && !isProgressControlled ? { key: "pb-" + updateId } : {}, {
		rtl,
		theme,
		delay: autoClose,
		isRunning,
...
var ToastContainer = function ToastContainer(props) {
	...
	return (0, import_react.createElement)("div", {
		...
		var containerStyle = !toastList.length ? _extends({}, style, { pointerEvents: "none" }) : _extends({}, style);
		return (0, import_react.createElement)("div", {
...
function dispatchToast(content, options) {
	if (containers.size > 0) eventManager.emit(0, content, options);
	else {
		queue.push({
			content,
			options
...
function handlePromise(promise, _ref2, options) {
	...
	var id;
	if (pending) id = isStr(pending) ? toast.loading(pending, options) : toast.loading(pending.render, _extends({}, options, pending));
	var resetParams = {
		isLoading: null,
		autoClose: null,
		closeOnClick: null,
	...
	var resolver = function resolver(type, input, result) {
		...
		var baseParams = _extends({ type }, resetParams, options, { data: result });
		var params = isStr(input) ? { render: input } : input;
		if (id) toast.update(id, _extends({}, baseParams, params));
		else toast(params.render, _extends({}, baseParams, params));
		return result;
	};
...
toast.dark = function(content, options) {
	return dispatchToast(content, mergeOptions(TYPE.DEFAULT, _extends({ theme: "dark" }, options)));
};
/**
