import { _ as isPlainObject, a as Operation, h as Transforms, o as Path, t as Editor } from "./index.es-wK-hlxEg.js";
...
var withHistory = (editor) => {
	...
	e.undo = () => {
		...
		if (undos.length > 0) {
			...
			HistoryEditor.withoutSaving(e, () => {
				Editor.withoutNormalizing(e, () => {
					for (var op of batch.operations.map(Operation.inverse).reverse()) e.apply(op);
					if (batch.selectionBefore) Transforms.setSelection(e, batch.selectionBefore);
				});
			});
