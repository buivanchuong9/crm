...
//#endregion
//#region node_modules/diagram-js/lib/draw/BaseRenderer.js
...
function BaseRenderer(eventBus, renderPriority) {
	...
	eventBus.on(["render.shape", "render.connection"], renderPriority, function(evt, context) {
		...
		if (self.canRender(element)) if (type === "render.shape") return self.drawShape(visuals, element, attrs);
		else return self.drawConnection(visuals, element, attrs);
	});
	eventBus.on(["render.getShapePath", "render.getConnectionPath"], renderPriority, function(evt, element) {
		if (self.canRender(element)) if (evt.type === "render.getShapePath") return self.getShapePath(element);
...
//#endregion
//#region node_modules/bpmn-js/lib/util/DiUtil.js
/**
...
function isExpanded(element, di) {
	if (is$1(element, "bpmn:CallActivity")) return false;
	if (is$1(element, "bpmn:SubProcess")) {
		di = di || getDi(element);
		if (di && is$1(di, "bpmndi:BPMNPlane")) return true;
		return di && !!di.isExpanded;
	}
	if (is$1(element, "bpmn:Participant")) return !!getBusinessObject(element).processRef;
	return true;
}
/**
* @param {Element} element
...
function isHorizontal(element) {
	if (!is$1(element, "bpmn:Participant") && !is$1(element, "bpmn:Lane")) return;
	var isHorizontal = getDi(element).isHorizontal;
	if (isHorizontal === void 0) return true;
	return isHorizontal;
}
/**
* @param {Element} element
...
//#endregion
//#region node_modules/bpmn-js/lib/draw/BpmnRenderUtil.js
...
function getStrokeColor(element, defaultColor, overrideColor) {
	var di = getDi(element);
	return overrideColor || di.get("color:border-color") || di.get("bioc:stroke") || defaultColor || "hsl(225, 10%, 15%)";
}
/**
* @param {Element} element
* @param {string} [defaultColor]
...
function getLabelColor(element, defaultColor, defaultStrokeColor, overrideColor) {
	var label = getDi(element).get("label");
...
var DEFAULT_OPACITY = .95, FULL_OPACITY = 1, LOW_OPACITY = .25;
/**
* @typedef { Partial<{
...
function BpmnRenderer(config, eventBus, styles, pathMap, canvas, textRenderer, priority) {
	...
	function createMarker(parentGfx, id, type, fill, stroke) {
		if (type === "sequenceflow-end") addMarker(id, {
			element: create$1("path", {
		...
		if (type === "messageflow-start") addMarker(id, {
			element: create$1("circle", {
				cx: 6,
				cy: 6,
				r: 3.5,
				...shapeStyle({
		...
		if (type === "messageflow-end") addMarker(id, {
			element: create$1("path", {
		...
		if (type === "association-start") addMarker(id, {
			element: create$1("path", {
		...
		if (type === "association-end") addMarker(id, {
			element: create$1("path", {
		...
		if (type === "conditional-flow-marker") addMarker(id, {
			element: create$1("path", {
		...
		if (type === "conditional-default-flow-marker") addMarker(id, {
			element: create$1("path", {
				d: "M 6 4 L 10 16",
				...shapeStyle({
					stroke,
	...
	*/
	...
	var eventIconRenderers = {
		"bpmn:MessageEventDefinition": function(parentGfx, element, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_MESSAGE", {
				xScaleFactor: .9,
				yScaleFactor: .9,
				...
				fill: isThrowing ? getStrokeColor(element, defaultStrokeColor, attrs.stroke) : getFillColor(element, defaultFillColor, attrs.fill),
				stroke: isThrowing ? getFillColor(element, defaultFillColor, attrs.fill) : getStrokeColor(element, defaultStrokeColor, attrs.stroke),
				strokeWidth: 1
			});
		},
		"bpmn:TimerEventDefinition": function(parentGfx, element, attrs = {}) {
			var circle = drawCircle(parentGfx, element.width, element.height, .2 * element.height, {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
				stroke: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
				strokeWidth: 2
			});
			drawPath(parentGfx, pathMap.getScaledPath("EVENT_TIMER_WH", {
				xScaleFactor: .75,
				yScaleFactor: .75,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"bpmn:EscalationEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_ESCALATION", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				...
				fill: isThrowing ? getStrokeColor(event, defaultStrokeColor, attrs.stroke) : getFillColor(event, defaultFillColor, attrs.fill),
		...
		"bpmn:ConditionalEventDefinition": function(parentGfx, event, attrs = {}) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_CONDITIONAL", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: event.width,
				containerHeight: event.height,
		...
		"bpmn:LinkEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_LINK", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: event.width,
				containerHeight: event.height,
		...
		"bpmn:ErrorEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_ERROR", {
				xScaleFactor: 1.1,
				yScaleFactor: 1.1,
				containerWidth: event.width,
				containerHeight: event.height,
		...
		"bpmn:CancelEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			var path = drawPath(parentGfx, pathMap.getScaledPath("EVENT_CANCEL_45", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: event.width,
				containerHeight: event.height,
				...
				fill: isThrowing ? getStrokeColor(event, defaultStrokeColor, attrs.stroke) : "none",
				stroke: getStrokeColor(event, defaultStrokeColor, attrs.stroke),
				strokeWidth: 1
			});
			rotate(path, 45);
		...
		"bpmn:CompensateEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_COMPENSATION", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: event.width,
				containerHeight: event.height,
		...
		"bpmn:SignalEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_SIGNAL", {
				xScaleFactor: .9,
				yScaleFactor: .9,
				containerWidth: event.width,
				containerHeight: event.height,
		...
		"bpmn:MultipleEventDefinition": function(parentGfx, event, attrs = {}, isThrowing) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_MULTIPLE", {
				xScaleFactor: 1.1,
				yScaleFactor: 1.1,
				containerWidth: event.width,
				containerHeight: event.height,
		...
		"bpmn:ParallelMultipleEventDefinition": function(parentGfx, event, attrs = {}) {
			return drawPath(parentGfx, pathMap.getScaledPath("EVENT_PARALLEL_MULTIPLE", {
				xScaleFactor: 1.2,
				yScaleFactor: 1.2,
				containerWidth: event.width,
				containerHeight: event.height,
	...
	function renderEventIcon(element, parentGfx, attrs = {}) {
		...
		if (semantic.get("eventDefinitions") && semantic.get("eventDefinitions").length > 1) if (semantic.get("parallelMultiple")) return eventIconRenderers["bpmn:ParallelMultipleEventDefinition"](parentGfx, element, attrs, isThrowing);
		else return eventIconRenderers["bpmn:MultipleEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:MessageEventDefinition")) return eventIconRenderers["bpmn:MessageEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:TimerEventDefinition")) return eventIconRenderers["bpmn:TimerEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:ConditionalEventDefinition")) return eventIconRenderers["bpmn:ConditionalEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:SignalEventDefinition")) return eventIconRenderers["bpmn:SignalEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:EscalationEventDefinition")) return eventIconRenderers["bpmn:EscalationEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:LinkEventDefinition")) return eventIconRenderers["bpmn:LinkEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:ErrorEventDefinition")) return eventIconRenderers["bpmn:ErrorEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:CancelEventDefinition")) return eventIconRenderers["bpmn:CancelEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:CompensateEventDefinition")) return eventIconRenderers["bpmn:CompensateEventDefinition"](parentGfx, element, attrs, isThrowing);
		if (isTypedEvent(semantic, "bpmn:TerminateEventDefinition")) return eventIconRenderers["bpmn:TerminateEventDefinition"](parentGfx, element, attrs, isThrowing);
		return null;
	}
	var taskMarkerRenderers = {
		"ParticipantMultiplicityMarker": function(parentGfx, element, attrs = {}) {
			...
			drawMarker("participant-multiplicity", parentGfx, pathMap.getScaledPath("MARKER_PARALLEL", {
				xScaleFactor: 1,
				yScaleFactor: 1,
		...
		"SubProcessMarker": function(parentGfx, element, attrs = {}) {
			translate$1(drawRect(parentGfx, 14, 14, 0, {
				strokeWidth: 1,
				fill: getFillColor(element, defaultFillColor, attrs.fill),
				stroke: getStrokeColor(element, defaultStrokeColor, attrs.stroke)
			}), element.width / 2 - 7.5, element.height - 20);
			drawMarker("sub-process", parentGfx, pathMap.getScaledPath("MARKER_SUB_PROCESS", {
				xScaleFactor: 1.5,
				yScaleFactor: 1.5,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"ParallelMarker": function(parentGfx, element, attrs) {
			var width = getWidth(element, attrs), height = getHeight(element, attrs);
			drawMarker("parallel", parentGfx, pathMap.getScaledPath("MARKER_PARALLEL", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: width,
				containerHeight: height,
		...
		"SequentialMarker": function(parentGfx, element, attrs) {
			drawMarker("sequential", parentGfx, pathMap.getScaledPath("MARKER_SEQUENTIAL", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"CompensationMarker": function(parentGfx, element, attrs) {
			drawMarker("compensation", parentGfx, pathMap.getScaledPath("MARKER_COMPENSATION", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"LoopMarker": function(parentGfx, element, attrs) {
			var width = getWidth(element, attrs), height = getHeight(element, attrs);
			drawMarker("loop", parentGfx, pathMap.getScaledPath("MARKER_LOOP", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: width,
				containerHeight: height,
		...
		"AdhocMarker": function(parentGfx, element, attrs) {
			var width = getWidth(element, attrs), height = getHeight(element, attrs);
			drawMarker("adhoc", parentGfx, pathMap.getScaledPath("MARKER_ADHOC", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: width,
				containerHeight: height,
	...
	function renderTaskMarkers(parentGfx, element, taskMarkers, attrs = {}) {
		...
		if (taskMarkers && taskMarkers.includes("SubProcessMarker")) attrs = {
			...attrs,
			seq: -21,
			parallel: -22,
			compensation: -42,
		...
		if (is$1(semantic, "bpmn:AdHocSubProcess")) renderTaskMarker("AdhocMarker", parentGfx, element, attrs);
		...
		if (loopCharacteristics) {
			if (isSequential === void 0) renderTaskMarker("LoopMarker", parentGfx, element, attrs);
	...
	function renderEmbeddedLabel(parentGfx, element, align, attrs = {}) {
		...
		return renderLabel(parentGfx, semantic.name, {
			...
			box,
			padding: 7,
			style: { fill: getLabelColor(element, defaultLabelColor, defaultStrokeColor, attrs.stroke) }
		});
	}
	...
	function renderLaneLabel(parentGfx, text, element, attrs = {}) {
		...
		if (isHorizontalLane) transform(textBox, 0, -(-1 * getHeight(element, attrs)), 270);
	}
	function renderActivity(parentGfx, element, attrs = {}) {
		var { width, height } = getBounds(element, attrs);
	...
	function renderDataObject(parentGfx, element, attrs = {}) {
		var fill = getFillColor(element, defaultFillColor, attrs.fill), stroke = getStrokeColor(element, defaultStrokeColor, attrs.stroke);
		var dataObject = drawPath(parentGfx, pathMap.getScaledPath("DATA_OBJECT_PATH", {
			xScaleFactor: 1,
			yScaleFactor: 1,
			containerWidth: element.width,
			containerHeight: element.height,
		...
		if (isCollection(getBusinessObject(element))) drawPath(parentGfx, pathMap.getScaledPath("DATA_OBJECT_COLLECTION_PATH", {
			xScaleFactor: 1,
			yScaleFactor: 1,
			containerWidth: element.width,
			containerHeight: element.height,
	...
	function renderLane(parentGfx, element, attrs = {}) {
		...
		var semantic = getBusinessObject(element);
		if (is$1(semantic, "bpmn:Lane")) renderLaneLabel(parentGfx, semantic.get("name"), element, attrs);
		return lane;
	}
	function renderSubProcess(parentGfx, element, attrs = {}) {
		var activity = renderActivity(parentGfx, element, attrs);
		if (isEventSubProcess(element)) attr$1(activity, {
			strokeDasharray: "0, 5.5",
			strokeWidth: 2.5
		});
		var expanded = isExpanded(element);
		renderEmbeddedLabel(parentGfx, element, expanded ? "center-top" : "center-middle", attrs);
		if (expanded) renderTaskMarkers(parentGfx, element, void 0, attrs);
		else renderTaskMarkers(parentGfx, element, ["SubProcessMarker"], attrs);
		return activity;
	}
	...
	var handlers = this.handlers = {
		"bpmn:AdHocSubProcess": function(parentGfx, element, attrs = {}) {
			if (isExpanded(element)) attrs = pickAttrs(attrs, [
				"fill",
				"stroke",
				"width",
				"height"
			]);
			else attrs = pickAttrs(attrs, ["fill", "stroke"]);
		...
		"bpmn:BoundaryEvent": function(parentGfx, element, attrs = {}) {
			...
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			var cancelActivity = getBusinessObject(element).get("cancelActivity");
			attrs = {
				strokeWidth: 1.5,
				fill: getFillColor(element, defaultFillColor, attrs.fill),
		...
		"bpmn:BusinessRuleTask": function(parentGfx, element, attrs = {}) {
			...
			attr$1(drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_BUSINESS_RULE_MAIN", { abspos: {
				x: 8,
				y: 8
			} })), {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
			...
			attr$1(drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_BUSINESS_RULE_HEADER", { abspos: {
				x: 8,
				y: 8
			} })), {
				fill: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
		...
		"bpmn:ComplexGateway": function(parentGfx, element, attrs = {}) {
			...
			drawPath(parentGfx, pathMap.getScaledPath("GATEWAY_COMPLEX", {
				xScaleFactor: .5,
				yScaleFactor: .5,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"bpmn:DataStoreReference": function(parentGfx, element, attrs = {}) {
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			return drawPath(parentGfx, pathMap.getScaledPath("DATA_STORE", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"bpmn:EventBasedGateway": function(parentGfx, element, attrs = {}) {
			...
			drawCircle(parentGfx, element.width, element.height, element.height * .2, {
			...
			function drawEvent() {
				drawPath(parentGfx, pathMap.getScaledPath("GATEWAY_EVENT_BASED", {
					xScaleFactor: .18,
					yScaleFactor: .18,
					containerWidth: element.width,
					containerHeight: element.height,
			...
			if (type === "Parallel") drawPath(parentGfx, pathMap.getScaledPath("GATEWAY_PARALLEL", {
				xScaleFactor: .4,
				yScaleFactor: .4,
				containerWidth: element.width,
				containerHeight: element.height,
				...
				if (!instantiate) drawCircle(parentGfx, element.width, element.height, element.height * .26, {
					fill: "none",
					stroke: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
					strokeWidth: 1
				});
		...
		"bpmn:ExclusiveGateway": function(parentGfx, element, attrs = {}) {
			...
			if (getDi(element).get("isMarkerVisible")) drawPath(parentGfx, pathData, {
				fill: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
				stroke: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
				strokeWidth: 1
			});
		...
		"bpmn:InclusiveGateway": function(parentGfx, element, attrs = {}) {
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			var gateway = renderGateway(parentGfx, element, attrs);
			drawCircle(parentGfx, element.width, element.height, element.height * .24, {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
				stroke: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
				strokeWidth: 2.5
			});
		...
		"bpmn:ManualTask": function(parentGfx, element, attrs = {}) {
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			var task = renderTask(parentGfx, element, attrs);
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_MANUAL", { abspos: {
				x: 17,
				y: 15
			} }), {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
		...
		"bpmn:MessageFlow": function(parentGfx, element, attrs = {}) {
			...
			if (semantic.get("messageRef")) {
				...
				var markerPathData = pathMap.getScaledPath("MESSAGE_FLOW_MARKER", { abspos: {
					x: midPoint.x,
					y: midPoint.y
				} });
				...
				var label = renderLabel(parentGfx, semantic.get("messageRef").get("name"), {
					align: "center-top",
					fitBox: true,
					style: { fill: stroke }
				});
				var messageBounds = message.getBBox(), labelBounds = label.getBBox();
				transform(label, midPoint.x - labelBounds.width / 2, midPoint.y + messageBounds.height / 2 + ELEMENT_LABEL_DISTANCE, 0);
			}
			return path;
		},
		"bpmn:ParallelGateway": function(parentGfx, element, attrs = {}) {
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			var diamond = renderGateway(parentGfx, element, attrs);
			drawPath(parentGfx, pathMap.getScaledPath("GATEWAY_PARALLEL", {
				xScaleFactor: .6,
				yScaleFactor: .6,
				containerWidth: element.width,
				containerHeight: element.height,
		...
		"bpmn:Participant": function(parentGfx, element, attrs = {}) {
			...
			var semantic = getBusinessObject(element), name = semantic.get("name");
			if (expandedParticipant) {
				drawLine(parentGfx, horizontalParticipant ? [{
					x: 30,
					y: 0
				}, {
					x: 30,
				...
				if (!horizontalParticipant) transform(textBox, 0, -(-1 * getHeight(element, attrs)), 270);
			}
		...
		"bpmn:ReceiveTask": function(parentGfx, element, attrs = {}) {
			...
			if (semantic.get("instantiate")) {
				drawCircle(parentGfx, 28, 28, 20 * .22, {
					fill: getFillColor(element, defaultFillColor, attrs.fill),
					stroke: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
					strokeWidth: 1
				});
				pathData = pathMap.getScaledPath("TASK_TYPE_INSTANTIATING_SEND", { abspos: {
					x: 7.77,
					y: 9.52
				} });
		...
		"bpmn:ScriptTask": function(parentGfx, element, attrs = {}) {
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			var task = renderTask(parentGfx, element, attrs);
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_SCRIPT", { abspos: {
				x: 15,
				y: 20
			} }), {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
		...
		"bpmn:SendTask": function(parentGfx, element, attrs = {}) {
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			var task = renderTask(parentGfx, element, attrs);
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_SEND", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: 21,
				containerHeight: 14,
		...
		"bpmn:SequenceFlow": function(parentGfx, element, attrs = {}) {
			...
			if (source) {
				...
				if (semantic.get("conditionExpression") && is$1(sourceSemantic, "bpmn:Activity")) attr$1(connection, { markerStart: marker(parentGfx, "conditional-flow-marker", fill, stroke) });
				if (sourceSemantic.get("default") && (is$1(sourceSemantic, "bpmn:Gateway") || is$1(sourceSemantic, "bpmn:Activity")) && sourceSemantic.get("default") === semantic) attr$1(connection, { markerStart: marker(parentGfx, "conditional-default-flow-marker", fill, stroke) });
			}
			return connection;
		},
		"bpmn:ServiceTask": function(parentGfx, element, attrs = {}) {
			...
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_SERVICE", { abspos: {
				x: 12,
				y: 18
			} }), {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
		...
		"bpmn:StartEvent": function(parentGfx, element, attrs = {}) {
			var { renderIcon = true } = attrs;
			attrs = pickAttrs(attrs, ["fill", "stroke"]);
			if (!getBusinessObject(element).get("isInterrupting")) attrs = {
				...attrs,
				strokeDasharray: "6"
			};
			var event = renderEvent(parentGfx, element, attrs);
		...
		"bpmn:TextAnnotation": function(parentGfx, element, attrs = {}) {
			...
			drawPath(parentGfx, pathMap.getScaledPath("TEXT_ANNOTATION", {
				xScaleFactor: 1,
				yScaleFactor: 1,
				containerWidth: width,
				containerHeight: height,
			...
			renderLabel(parentGfx, getBusinessObject(element).get("text") || "", {
				align: "left-top",
		...
		"bpmn:UserTask": function(parentGfx, element, attrs = {}) {
			...
			var x = 15;
			var y = 12;
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_USER_1", { abspos: {
				x,
				y
			} }), {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
			...
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_USER_2", { abspos: {
				x,
				y
			} }), {
				fill: getFillColor(element, defaultFillColor, attrs.fill),
			...
			drawPath(parentGfx, pathMap.getScaledPath("TASK_TYPE_USER_3", { abspos: {
				x,
				y
			} }), {
				fill: getStrokeColor(element, defaultStrokeColor, attrs.stroke),
...
BpmnRenderer.prototype.drawShape = function(parentGfx, shape, attrs = {}) {
	var { type } = shape;
	return this._renderer(type)(parentGfx, shape, attrs);
};
/**
...
BpmnRenderer.prototype.drawConnection = function(parentGfx, connection, attrs = {}) {
	var { type } = connection;
	return this._renderer(type)(parentGfx, connection, attrs);
};
/**
* Get shape path.
*
...
BpmnRenderer.prototype.getShapePath = function(shape) {
	if (is$1(shape, "bpmn:Event")) return getCirclePath(shape);
	if (is$1(shape, "bpmn:Activity")) return getRoundRectPath(shape, TASK_BORDER_RADIUS);
	if (is$1(shape, "bpmn:Gateway")) return getDiamondPath(shape);
...
//#endregion
//#region node_modules/diagram-js/lib/util/Text.js
/**
...
function semanticShorten(line, maxLength) {
	...
	if (parts.length > 1) while (part = parts.shift()) if (part.length + length < maxLength) {
...
function shortenLine(line, width, maxWidth) {
	...
	if (!shortenedLine) shortenedLine = line.slice(0, Math.max(Math.round(length - 1), 1));
...
Text.prototype.layoutText = function(text, options) {
	...
	append(getHelperSvg(), helperText);
	...
	forEach$3(layouted, function(line) {
		...
		switch (align.horizontal) {
			...
			case "right":
				...
				break;
			default: x = Math.max(((fitBox ? maxLineWidth : maxWidth) - line.width) / 2 + padding.left, 0);
		}
...
//#endregion
//#region node_modules/bpmn-js/lib/draw/TextRenderer.js
...
//#endregion
//#region node_modules/bpmn-js/lib/draw/PathMap.js
/**
...
//#endregion
//#region node_modules/bpmn-js/lib/draw/index.js
var draw_default$1 = {
...
//#endregion
//#region node_modules/diagram-js/lib/i18n/translate/translate.js
/**
* @typedef { {
*   [key: string]: string;
...
//#endregion
//#region node_modules/diagram-js/lib/i18n/translate/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
var translate_default = { translate: ["value", translate] }, math = Math;
math.PI;
math.min;
math.max;
math.pow;
...
Array.isArray;
//#endregion
//#region node_modules/diagram-js/lib/layout/LayoutUtil.js
/**
* @param {Point} point
*
* @returns {Point}
...
function getConnectionMid(connection) {
	...
	var midLength = parts.reduce(function(length, part) {
...
function getMid(element) {
	if (isConnection(element)) return getConnectionMid(element);
...
//#endregion
//#region node_modules/bpmn-js/lib/import/Util.js
function elementToString(e) {
	if (!e) return "<null>";
	return "<" + e.$type + (e.id ? " id=\"" + e.id : "") + "\" />";
}
//#endregion
//#region node_modules/bpmn-js/lib/import/BpmnImporter.js
/**
...
function getWaypoints(di, source, target) {
	...
	if (!waypoints || waypoints.length < 2) return [getMid(source), getMid(target)];
...
function notYetDrawn(semantic, refSemantic, property) {
	return /* @__PURE__ */ new Error(`element ${elementToString(refSemantic)} referenced by ${elementToString(semantic)}#${property} not yet drawn`);
}
/**
...
BpmnImporter.prototype.add = function(semantic, di, parentElement) {
	...
	if (is$1(di, "bpmndi:BPMNPlane")) {
		...
		if (is$1(semantic, "bpmn:BoundaryEvent")) this._attachBoundary(semantic, element);
		if (is$1(semantic, "bpmn:Lane")) parentIndex = 0;
		if (is$1(semantic, "bpmn:DataStoreReference")) {
			if (!isPointInsideBBox(parentElement, getMid(bounds))) parentElement = this._canvas.findRoot(parentElement);
		}
		...
		if (is$1(semantic, "bpmn:DataAssociation")) parentElement = this._canvas.findRoot(parentElement);
		this._canvas.addConnection(element, parentElement, parentIndex);
	} else throw new Error(`unknown di ${elementToString(di)} for element ${elementToString(semantic)}`);
	if (isLabelExternal(semantic) && getLabel(element)) this.addLabel(semantic, di, element);
...
BpmnImporter.prototype._attachBoundary = function(boundarySemantic, boundaryElement) {
	...
	if (!hostSemantic) throw new Error(`missing ${elementToString(boundarySemantic)}#attachedToRef`);
...
BpmnImporter.prototype.addLabel = function(semantic, di, element) {
	var bounds = getExternalLabelBounds(di, element), text = getLabel(element), label;
	if (text) bounds = this._textRenderer.getExternalLabelBounds(bounds, text);
...
BpmnImporter.prototype._getConnectedElement = function(semantic, side) {
	...
	else throw new Error(`${elementToString(semantic)}#${side} Ref not specified`);
};
...
//#endregion
//#region node_modules/bpmn-js/lib/core/index.js
var core_default$1 = { __depends__: [draw_default$1, {
	__depends__: [translate_default],
	bpmnImporter: ["type", BpmnImporter]
}] };
//#endregion
//#region node_modules/diagram-js/lib/features/overlays/Overlays.js
...
Overlays.prototype._updateOverlay = function(overlay) {
	...
	if (position.right !== void 0) {
		var width;
		if (element.waypoints) width = getBBox(element).width;
		else width = element.width;
		left = position.right * -1 + width;
	}
	if (position.bottom !== void 0) {
		var height;
		if (element.waypoints) height = getBBox(element).height;
...
//#endregion
//#region node_modules/diagram-js/lib/features/overlays/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
...
//#endregion
//#region node_modules/diagram-js/lib/features/change-support/ChangeSupport.js
/**
* @typedef {import('../../core/Canvas').default} Canvas
* @typedef {import('../../core/ElementRegistry').default} ElementRegistry
* @typedef {import('../../core/EventBus').default} EventBus
...
//#endregion
//#region node_modules/diagram-js/lib/features/change-support/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
...
//#endregion
//#region node_modules/diagram-js/lib/command/CommandInterceptor.js
/**
...
//#endregion
//#region node_modules/diagram-js/lib/features/root-elements/RootElementsBehavior.js
/**
...
//#endregion
//#region node_modules/diagram-js/lib/features/root-elements/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
...
//#endregion
//#region node_modules/diagram-js/lib/util/EscapeUtil.js
var HTML_ESCAPE_MAP = {
	"&": "&amp;",
	"<": "&lt;",
	">": "&gt;",
...
//#endregion
//#region node_modules/bpmn-js/lib/util/DrilldownUtil.js
/**
* @typedef {import('../model/Types').Element} Element
* @typedef {import('../model/Types').ModdleElement} ModdleElement
*/
...
function getPlaneIdFromShape(element) {
	var id = element.id;
	if (is$1(element, "bpmn:SubProcess")) return addPlaneSuffix(id);
	return id;
}
...
//#endregion
//#region node_modules/bpmn-js/lib/features/drilldown/DrilldownBreadcrumbs.js
/**
* @typedef {import('diagram-js/lib/core/Canvas').default} Canvas
* @typedef {import('diagram-js/lib/core/ElementRegistry').default} ElementRegistry
* @typedef {import('diagram-js/lib/core/EventBus').default} EventBus
...
function getBusinessObjectParentChain(child) {
	...
	var parents = [];
	for (var element = businessObject; element; element = element.$parent) if (is$1(element, "bpmn:SubProcess") || is$1(element, "bpmn:Process")) parents.push(element);
	return parents.reverse();
}
//#endregion
//#region node_modules/bpmn-js/lib/features/drilldown/DrilldownCentering.js
/**
* @typedef {import('diagram-js/lib/core/Canvas').default} Canvas
* @typedef {import('diagram-js/lib/core/EventBus').default} EventBus
*/
...
function DrilldownCentering(eventBus, canvas) {
	...
	eventBus.on("root.set", function(event) {
		...
		currentRoot = newRoot;
		if (!is$1(newRoot, "bpmn:SubProcess") && !storedViewbox) return;
...
function Map() {
	...
	this.set = function(key, value) {
		...
		if (!found) this._entries.push([key, value]);
	};
	this.get = function(key) {
		for (var k in this._entries) if (this._entries[k][0] === key) return this._entries[k][1];
		return null;
	};
	this.clear = function() {
...
//#endregion
//#region node_modules/bpmn-js/lib/features/drilldown/SubprocessCompatibility.js
/**
* @typedef {import('diagram-js/lib/core/EventBus').default} EventBus
...
SubprocessCompatibility.prototype._handleImport = function(definitions) {
	...
	definitions.diagrams.filter((diagram) => diagram.plane).flatMap((diagram) => self._createNewDiagrams(diagram.plane)).forEach(function(diagram) {
...
SubprocessCompatibility.prototype._createNewDiagrams = function(plane) {
	...
	plane.get("planeElement").forEach(function(diElement) {
		...
		if (is$1(businessObject, "bpmn:SubProcess") && !diElement.isExpanded) collapsedElements.push(businessObject);
		if (shouldMoveToPlane(businessObject, plane)) elementsToMove.push({
			diElement,
			parent
		});
	});
...
SubprocessCompatibility.prototype._moveToDiPlane = function(diElement, newPlane) {
	var parentPlaneElement = findRootDiagram(diElement).plane.get("planeElement");
...
SubprocessCompatibility.prototype._createDiagram = function(businessObject) {
	var plane = this._moddle.create("bpmndi:BPMNPlane", { bpmnElement: businessObject });
	var diagram = this._moddle.create("bpmndi:BPMNDiagram", { plane });
...
function findRootDiagram(element) {
	if (is$1(element, "bpmndi:BPMNDiagram")) return element;
...
function shouldMoveToPlane(businessObject, plane) {
	var parent = businessObject.$parent;
	if (!is$1(parent, "bpmn:SubProcess") || parent === plane.bpmnElement) return false;
	if (isAny(businessObject, ["bpmn:DataInputAssociation", "bpmn:DataOutputAssociation"])) return false;
	return true;
}
//#endregion
//#region node_modules/bpmn-js/lib/features/drilldown/DrilldownOverlayBehavior.js
/**
* @typedef {import('diagram-js/lib/core/Canvas').default} Canvas
* @typedef {import('diagram-js/lib/core/ElementRegistry').default} ElementRegistry
* @typedef {import('diagram-js/lib/core/EventBus').default} EventBus
...
DrilldownOverlayBehavior.prototype._addOverlay = function(element) {
	...
	if (overlays.get({
		element,
		type: "drilldown"
	}).length) this._removeOverlay(element);
...
//#endregion
//#region node_modules/bpmn-js/lib/features/drilldown/index.js
var drilldown_default = {
	__depends__: [
		overlays_default,
		change_support_default,
		root_elements_default
	],
	__init__: [
...
//#endregion
//#region node_modules/bpmn-js/lib/features/outline/OutlineUtil.js
...
//#endregion
//#region node_modules/bpmn-js/lib/features/outline/OutlineProvider.js
/**
...
OutlineProvider.prototype.getOutline = function(element) {
	...
	} else if (is$1(element, "bpmn:DataObjectReference") && isStandardSize(element, "bpmn:DataObjectReference")) outline = createPath(DATA_OBJECT_REFERENCE_OUTLINE_PATH, {
		x: -6,
		y: -6
	}, OUTLINE_STYLE);
	else if (is$1(element, "bpmn:DataStoreReference") && isStandardSize(element, "bpmn:DataStoreReference")) outline = createPath(DATA_STORE_REFERENCE_OUTLINE_PATH, {
		x: -6,
		y: -6
	}, OUTLINE_STYLE);
	return outline;
...
function isStandardSize(element, type) {
	var standardSize;
	if (type === "bpmn:DataObjectReference") standardSize = DATA_OBJECT_REFERENCE_STANDARD_SIZE;
	else if (type === "bpmn:DataStoreReference") standardSize = DATA_STORE_REFERENCE_STANDARD_SIZE;
	return element.width === standardSize.width && element.height === standardSize.height;
}
//#endregion
//#region node_modules/bpmn-js/lib/features/outline/index.js
var outline_default = {
	__depends__: [outline_default$1],
...
//#endregion
//#region node_modules/diagram-js/lib/draw/Styles.js
/**
...
//#endregion
//#region node_modules/diagram-js/lib/draw/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
var draw_default = {
...
//#endregion
//#region node_modules/diagram-js/lib/util/Collections.js
/**
...
function add(collection, element, idx) {
	...
	if (currentIdx !== -1) if (currentIdx === idx) return;
	else if (idx !== -1) collection.splice(currentIdx, 1);
	else return;
	if (idx !== -1) collection.splice(idx, 0, element);
	else collection.push(element);
}
//#endregion
//#region node_modules/diagram-js/lib/core/Canvas.js
/**
...
Canvas.prototype.findRoot = function(element) {
	...
	if (!element) return;
	return (this._findPlaneForRoot(findRoot(element)) || {}).rootElement;
};
/**
...
Canvas.prototype.removeRootElement = function(rootElement) {
	...
	if (!this._findPlaneForRoot(rootElement)) return;
...
Canvas.prototype._ensureValid = function(type, element) {
	...
	if (!every(requiredAttrs, function(attr) {
...
Canvas.prototype.viewbox = function(box) {
	if (box === void 0 && this._cachedViewbox) return structuredClone(this._cachedViewbox);
	...
	if (!box) {
		...
		transform$1(viewport, this._svg.createSVGMatrix().scale(scale).translate(-box.x, -box.y));
	});
	return box;
};
/**
...
Canvas.prototype.scrollToElement = function(element, padding) {
	...
	if (!(elementBounds.width < viewboxBounds.width && elementBounds.height < viewboxBounds.height)) {
...
Canvas.prototype.getAbsoluteBBox = function(element) {
	...
	let bbox;
	if (element.waypoints) bbox = this.getGraphics(element).getBBox();
	else bbox = element;
	return {
		x: bbox.x * vbox.scale - vbox.x * vbox.scale,
		y: bbox.y * vbox.scale - vbox.y * vbox.scale,
...
//#endregion
//#region node_modules/diagram-js/lib/core/ElementRegistry.js
...
ElementRegistry.prototype.add = function(element, gfx, secondaryGfx) {
	...
	if (secondaryGfx) attr$1(secondaryGfx, ELEMENT_ID, id);
	this._elements[id] = {
		element,
		gfx,
		secondaryGfx
...
ElementRegistry.prototype.remove = function(element) {
	...
	if (container) {
		...
		if (container.secondaryGfx) attr$1(container.secondaryGfx, ELEMENT_ID, "");
		delete elements[id];
	}
};
/**
...
ElementRegistry.prototype.updateGraphics = function(filter, gfx, secondary) {
	...
	if (gfx) attr$1(gfx, ELEMENT_ID, id);
	return gfx;
};
/**
...
ElementRegistry.prototype.get = function(filter) {
	...
	else id = filter && attr$1(filter, ELEMENT_ID);
	var container = this._elements[id];
...
ElementRegistry.prototype.find = function(fn) {
	...
	for (var i = 0; i < keys.length; i++) {
		var container = map[keys[i]], element = container.element, gfx = container.gfx;
...
//#endregion
//#region node_modules/object-refs/dist/index.js
/**
...
function extend(collection, refs, property, target) {
	...
	*/
	Object.defineProperty(collection, "remove", { value: function(element) {
	...
	*/
	Object.defineProperty(collection, "contains", { value: function(element) {
	...
	*/
	Object.defineProperty(collection, "add", { value: function(element, idx) {
		var currentIdx = this.indexOf(element);
		if (typeof idx === "undefined") {
			if (currentIdx !== -1) return;
			idx = this.length;
		}
		if (currentIdx !== -1) this.splice(currentIdx, 1);
		this.splice(idx, 0, element);
		if (currentIdx === -1) refs.set(element, inverseProperty, target);
	} });
	Object.defineProperty(collection, "__refs_collection", { value: true });
	return collection;
}
/**
...
Refs.prototype.bind = function(target, property) {
	...
	else defineProperty$1(this, property, target);
};
...
Refs.prototype.ensureBound = function(target, property) {
	if (!hasOwnProperty$1(target, property)) this.bind(target, property);
};
Refs.prototype.unset = function(target, property, value) {
	if (target) {
		this.ensureBound(target, property);
		if (property.collection) this.ensureRefsCollection(target, property).remove(value);
		else target[property.name] = void 0;
	}
};
...
//#endregion
//#region node_modules/diagram-js/lib/model/index.js
var parentRefs = new Refs({
	name: "children",
	enumerable: true,
	collection: true
}, { name: "parent" }), labelRefs = new Refs({
	name: "labels",
	enumerable: true,
	collection: true
}, { name: "labelTarget" }), attacherRefs = new Refs({
	name: "attachers",
	collection: true
}, { name: "host" }), outgoingRefs = new Refs({
	name: "outgoing",
	collection: true
}, { name: "source" }), incomingRefs = new Refs({
	name: "incoming",
	collection: true
}, { name: "target" });
/**
...
function ElementImpl() {
	...
	* @type Object
	*/
	Object.defineProperty(this, "businessObject", { writable: true });
	/**
...
//#endregion
//#region node_modules/diagram-js/lib/core/EventBus.js
var FN_REF = "__fn";
...
//#endregion
//#region node_modules/diagram-js/lib/core/GraphicsFactory.js
/**
* @typedef {import('./Types').ConnectionLike} ConnectionLike
* @typedef {import('./Types').ElementLike} ElementLike
* @typedef {import('./Types').ShapeLike} ShapeLike
...
GraphicsFactory.prototype.getShapePath = function(element) {
	return this._eventBus.fire("render.getShapePath", element);
};
/**
* Draw a connection.
*
...
GraphicsFactory.prototype.getConnectionPath = function(connection) {
	return this._eventBus.fire("render.getConnectionPath", connection);
};
/**
...
GraphicsFactory.prototype.update = function(type, element, gfx) {
	...
	if (element.hidden) attr$1(gfx, "display", "none");
	else attr$1(gfx, "display", "block");
};
/**
...
//#endregion
//#region node_modules/diagram-js/lib/core/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
var core_default = {
...
//#endregion
//#region node_modules/diagram-js/lib/Diagram.js
/**
...
function createInjector(options) {
	options = options || {};
	return bootstrap([{ "config": ["value", options] }, core_default].concat(options.modules || []));
}
/**
...
DescriptorBuilder.prototype.addProperty = function(p, idx, validate) {
	...
	if (idx !== void 0) properties.splice(idx, 0, p);
...
DescriptorBuilder.prototype.assertNotTrait = function(typeDescriptor) {
	if ((typeDescriptor.extends || []).length) throw new Error(`cannot create <${typeDescriptor.name}> extending <${typeDescriptor.extends}>`);
};
...
DescriptorBuilder.prototype.addTrait = function(t, inherited) {
	...
	forEach$1(t.properties, bind(function(p) {
		...
		Object.defineProperty(p, "definedBy", { value: t });
...
Properties.prototype.getProperty = function(target, name) {
	...
	if (typeof strict !== "undefined") {
		const error = /* @__PURE__ */ new TypeError(`unknown property <${name}> on <${target.$type}>`);
		if (strict) throw error;
		else typeof console !== "undefined" && console.warn(error);
	}
	return null;
};
...
function replaceEntities(_, d, x, z) {
	if (z) if (hasOwnProperty.call(ENTITY_MAPPING, z)) return ENTITY_MAPPING[z];
	else return "&" + z + ";";
...
function Parser(options) {
	...
	*/
	function handleError(err) {
		if (!(err instanceof Error)) err = error$1(err);
		returnError = err;
	...
	*/
	this["on"] = function(name, cb) {
		if (typeof cb !== "function") throw error$1("required args <name, cb>");
		switch (name) {
			case "openTag":
				onOpenTag = cb;
				break;
			...
			case "comment":
				onComment = cb;
				break;
			default: throw error$1("unsupported event: " + name);
		}
		return this;
	};
	/**
	...
	*/
	this["ns"] = function(nsMap) {
		...
		if (typeof nsMap !== "object") throw error$1("required args <nsMap={}>");
	...
	*/
	this["parse"] = function(xml) {
		if (typeof xml !== "string") throw error$1("required args <xml=string>");
		returnError = null;
		parse(xml);
		...
		*/
		...
		while (j !== -1) {
			...
			if (tagEnd) {
				...
				if (isNamespace) if (!tagStart) nsMatrix = nsMatrixStack.pop();
...
//#endregion
//#region node_modules/moddle-xml/dist/index.esm.js
...
function normalizeXsiTypeName(name, model) {
	var nameNs = parseName(name);
	return prefixedToName(nameNs, model.getPackage(nameNs.prefix));
}
...
function Context(options) {
	...
	*/
	this.addElement = function(element) {
		...
		var idProperty = getModdleDescriptor(element).idProperty, id;
		if (idProperty) {
...
ElementHandler.prototype.handleText = function(text) {
	...
	if (!getModdleDescriptor(element).bodyProperty) throw error("unexpected body text <" + text + ">");
	BodyHandler.prototype.handleText.call(this, text);
};
ElementHandler.prototype.handleEnd = function() {
	var value = this.body, element = this.element, bodyProperty = getModdleDescriptor(element).bodyProperty;
...
ElementHandler.prototype.createElement = function(node) {
	...
	forEach(attributes, function(value, name) {
		...
		if (prop && prop.isReference) if (!prop.isMany) context.addReference({
			element: instance,
			...
			if (prop) value = coerceType(prop.type, value);
			else if (name !== "xmlns") {
...
ElementHandler.prototype.getPropertyForNode = function(node) {
	...
	if (pkg) {
		...
		if (property) return assign({}, property, { effectiveType: getModdleDescriptor(elementType).name });
	} else {
		property = find(descriptor.properties, function(p) {
...
ElementHandler.prototype.handleChild = function(node) {
	var propertyDesc = this.getPropertyForNode(node), type, element = this.element, childHandler;
	type = propertyDesc.effectiveType || propertyDesc.type;
	if (isSimple(type)) return this.valueHandler(propertyDesc, element);
	...
	if (newElement !== void 0) {
		...
		if (propertyDesc.isReference) {
			assign(newElement, { element });
			this.context.addReference(newElement);
		} else newElement.$parent = element;
	}
	return childHandler;
};
/**
...
RootElementHandler.prototype.createElement = function(node) {
	var name = node.name, nameNs = parseName(name), model = this.model, type = this.type, pkg = model.getPackage(nameNs.prefix), typeName = pkg && aliasToName(nameNs, pkg) || name;
...
GenericElementHandler.prototype.createElement = function(node) {
	var name = node.name, prefix = parseName(name).prefix, uri = node.ns[prefix + "$uri"], attributes = node.attributes;
...
function Reader(options) {
	if (options instanceof Moddle) options = { model: options };
...
Reader.prototype.fromXML = function(xml, options, done) {
	...
	if (options instanceof ElementHandler) {
		...
		options = {};
	} else if (typeof rootHandler === "string") rootHandler = this.handler(rootHandler);
	...
	*/
	function resolveReferences() {
		...
		for (i = 0; r = references[i]; i++) {
			...
			if (property.isMany) {
				...
				if (!reference) collection.splice(idx, 1);
				else collection[idx] = reference;
	...
	function handleQuestion(question) {
		...
		context.addWarning({ message: "unsupported document encoding <" + encoding + ">, falling back to UTF-8" });
	}
...
function createStack() {
	var stack = [];
	Object.defineProperty(stack, "peek", { value: function() {
...
function Namespaces(parent) {
	...
	this.getUsed = function(ns) {
		function isUsed(ns) {
			return used[self.getNSKey(ns)];
		}
		var self = this;
		return [].concat(wellknown, custom).filter(isUsed);
	};
}
...
function getNsAttrs(namespaces) {
	return namespaces.getUsed().filter(function(ns) {
		...
		return {
			name: "xmlns" + (ns.prefix ? ":" + ns.prefix : ""),
			value: ns.uri
		};
	});
}
function getElementNs(ns, descriptor) {
	if (descriptor.isGeneric) return assign({ localName: descriptor.ns.localName }, ns);
	else return assign({ localName: nameToAlias(descriptor.ns.localName, descriptor.$pkg) }, ns);
}
...
function getSerializableProperties(element) {
	...
	return filter(descriptor.properties, function(p) {
		...
		if (!has(element, name)) return false;
...
ElementSerializer.prototype.nsTagName = function(descriptor) {
	return getElementNs(this.logNamespaceUsed(descriptor.ns), descriptor);
};
ElementSerializer.prototype.nsPropertyTagName = function(descriptor) {
	return getPropertyNs(this.logNamespaceUsed(descriptor.ns), descriptor);
};
...
ElementSerializer.prototype.nsAttributeName = function(element) {
	var ns;
	if (isString(element)) ns = parseName(element);
	else ns = element.ns;
	if (element.inherited) return { localName: ns.localName };
	var effectiveNs = this.logNamespaceUsed(ns);
	this.getNamespaces().logUsed(effectiveNs);
	if (this.isLocalNs(effectiveNs)) return { localName: ns.localName };
	else return assign({ localName: ns.localName }, effectiveNs);
};
ElementSerializer.prototype.parseGeneric = function(element) {
	...
	forEach(element, function(val, key) {
		var nonNsAttr;
		if (key === "$body") body.push(new BodySerializer().build({ type: "String" }, val));
		else if (key === "$children") forEach(val, function(child) {
...
ElementSerializer.prototype.parseNsAttribute = function(element, name, value) {
	...
	if (!nameNs.prefix && nameNs.localName === "xmlns") ns = { uri: value };
	if (!ns) return {
		name,
		value
	};
	if (model && model.getPackage(value)) this.logNamespace(ns, true, true);
	else {
...
ElementSerializer.prototype.parseContainments = function(properties) {
	...
	forEach(properties, function(p) {
		var value = element.get(p.name), isReference = p.isReference;
		if (!p.isMany) value = [value];
		if (p.isBody) body.push(new BodySerializer().build(p, value[0]));
		else if (isSimple(p.type)) forEach(value, function(v) {
			body.push(new ValueSerializer(self.addTagName(self.nsPropertyTagName(p))).build(p, v));
		});
		else if (isReference) forEach(value, function(v) {
			...
			forEach(value, function(v) {
				var serializer;
				if (asType) serializer = new TypeSerializer(self, p);
				else if (asProperty) serializer = new ElementSerializer(self, p);
...
ElementSerializer.prototype.logNamespace = function(ns, wellknown, local) {
	...
	if (!namespaces.byUri(nsUri) || local) namespaces.add(ns, wellknown);
	namespaces.mapPrefix(nsPrefix, nsUri);
	return ns;
};
ElementSerializer.prototype.logNamespaceUsed = function(ns, local) {
	var model = this.element.$model, namespaces = this.getNamespaces(local);
	var prefix = ns.prefix, uri = ns.uri, newPrefix, idx, wellknownUri;
	if (!prefix && !uri) return { localName: ns.localName };
...
ElementSerializer.prototype.parseAttributes = function(properties) {
	...
	forEach(properties, function(p) {
		...
		if (p.isReference) if (!p.isMany) value = value.id;
		else {
			var values = [];
			forEach(value, function(v) {
				values.push(v.id);
...
ElementSerializer.prototype.addAttribute = function(name, value) {
	...
	if (isString(value)) value = escapeAttr(value);
...
//#endregion
//#region node_modules/bpmn-moddle/dist/index.esm.js
/**
...
BpmnModdle.prototype.toXML = function(element, options) {
	...
	return new Promise(function(resolve, reject) {
		try {
			return resolve({ xml: writer.toXML(element) });
		} catch (err) {
			return reject(err);
		}
	});
...
//#endregion
//#region node_modules/bpmn-js/lib/import/BpmnTreeWalker.js
/**
* @typedef {import('../model/Types').ModdleElement} ModdleElement
*/
/**
...
function BpmnTreeWalker(handler) {
	...
	function visit(element, ctx) {
		if (element.gfx) throw new Error(`already rendered ${elementToString(element)}`);
	...
	var registerDi = this.registerDi = function registerDi(di) {
		...
		if (bpmnElement) if (diMap[bpmnElement.id]) logError(`multiple DI elements defined for ${elementToString(bpmnElement)}`, { element: bpmnElement });
		else {
			diMap[bpmnElement.id] = di;
			ensureCompatDiRef(bpmnElement);
		}
		else logError(`no bpmnElement referenced in ${elementToString(di)}`, { element: di });
	};
	...
	*/
	this.handleDefinitions = function handleDefinitions(definitions, diagram) {
		...
		if (!plane) throw new Error(`no plane for ${elementToString(diagram)}`);
		...
		} else throw new Error(`unsupported bpmnElement for ${elementToString(plane)}: ${elementToString(rootElement)}`);
	...
	function handleFlowElements(flowElements, context) {
		forEach$4(flowElements, function(flowElement) {
			...
			else if (is(flowElement, "bpmn:DataObject")) {} else if (is(flowElement, "bpmn:DataStoreReference")) handleDataElement(flowElement, context);
			else if (is(flowElement, "bpmn:DataObjectReference")) handleDataElement(flowElement, context);
			else logError(`unrecognized flowElement ${elementToString(flowElement)} in context ${elementToString(context && context.businessObject)}`, {
				element: flowElement,
				context
			});
		});
...
//#endregion
//#region node_modules/bpmn-js/lib/import/Importer.js
/**
* @typedef {import('../model/Types').ModdleElement} ModdleElement
*
* @typedef { {
...
function findRootProcess(element) {
	var parent = element;
	while (parent) {
		if (is$1(parent, "bpmn:Process")) return parent;
...
var LOGO_STYLES = { verticalAlign: "middle" };
var LINK_STYLES = { "color": "#404040" };
var LIGHTBOX_STYLES = {
	"zIndex": "1001",
	"position": "fixed",
	"top": "0",
...
//#endregion
//#region node_modules/bpmn-js/lib/BaseViewer.js
/**
...
BaseViewer.prototype.importDefinitions = async function importDefinitions(definitions, bpmnDiagram) {
	...
	return { warnings: (await this.open(bpmnDiagram)).warnings };
};
/**
...
BaseViewer.prototype.open = async function open(bpmnDiagramOrId) {
	...
	if (!definitions) {
		const error = /* @__PURE__ */ new Error("no XML imported");
	...
	if (typeof bpmnDiagramOrId === "string") {
		...
		if (!bpmnDiagram) {
			const error = /* @__PURE__ */ new Error("BPMNDiagram <" + bpmnDiagramOrId + "> not found");
			addWarningsToError(error, []);
			throw error;
		}
	}
...
BaseViewer.prototype.saveXML = async function saveXML(options) {
	...
	try {
		...
		*/
		definitions = this._emit("saveXML.start", { definitions }) || definitions;
		xml = (await this._moddle.toXML(definitions, options)).xml;
		xml = this._emit("saveXML.serialized", { xml }) || xml;
	} catch (err) {
		error = err;
	}
...
BaseViewer.prototype.attachTo = function(parentNode) {
	...
	if (typeof parentNode === "string") parentNode = query(parentNode);
...
function checkValidationError(err) {
	const match = /unparsable content <([^>]+)> detected([\s\S]*)$/.exec(err.message);
...
//#endregion
//#region node_modules/bpmn-js/lib/Viewer.js
/**
...
//#endregion
//#region node_modules/diagram-js/lib/navigation/keyboard-move/KeyboardMove.js
/**
* @typedef {import('../../core/Canvas').default} Canvas
...
function KeyboardMove(config, keyboard, canvas) {
	...
	*/
	this.moveCanvas = function(options) {
		var dx = 0, dy = 0;
		var actualSpeed = options.speed / Math.min(Math.sqrt(canvas.viewbox().scale), 1);
...
//#endregion
//#region node_modules/diagram-js/lib/navigation/keyboard-move/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
var keyboard_move_default = {
	__depends__: [keyboard_default],
	__init__: ["keyboardMove"],
	keyboardMove: ["type", KeyboardMove]
};
//#endregion
//#region node_modules/diagram-js/lib/navigation/movecanvas/MoveCanvas.js
/**
* @typedef {import('../../core/Canvas').default} Canvas
* @typedef {import('../../core/EventBus').default} EventBus
*/
...
function MoveCanvas(eventBus, canvas) {
	...
	function handleMove(event) {
		...
		if (!context.dragging && length(delta$1) > THRESHOLD) {
			...
			if (button === 0) install(eventBus);
			set$1("grab");
		}
		if (context.dragging) {
			delta$1 = delta(position, context.last || context.start);
			canvas.scroll({
				dx: delta$1.x,
				dy: delta$1.y
			});
...
//#endregion
//#region node_modules/diagram-js/lib/navigation/movecanvas/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
...
//#endregion
//#region node_modules/diagram-js/lib/util/Math.js
/**
...
//#endregion
//#region node_modules/diagram-js/lib/navigation/zoomscroll/ZoomUtil.js
/**
...
function getStepSize(range, steps) {
	...
	return (Math.abs(minLinearRange) + Math.abs(maxLinearRange)) / steps;
}
/**
* @param {Object} range
* @param {number} range.min
...
//#endregion
//#region node_modules/diagram-js/lib/navigation/zoomscroll/ZoomScroll.js
/**
* @typedef {import('../../core/Canvas').default} Canvas
* @typedef {import('../../core/EventBus').default} EventBus
*
...
ZoomScroll.prototype._handleWheel = function handleWheel(event) {
	...
	if (isZoom) factor *= event.deltaMode === 0 ? .02 : .32;
	else factor *= event.deltaMode === 0 ? 1 : 16;
	if (isZoom) {
...
//#endregion
//#region node_modules/diagram-js/lib/navigation/zoomscroll/index.js
/**
* @type { import('didi').ModuleDeclaration }
*/
...
//#endregion
//#region node_modules/bpmn-js/lib/NavigatedViewer.js
/**
* @typedef { import('./BaseViewer').BaseViewerOptions } BaseViewerOptions
*/
/**
...
//#endregion
export { NavigatedViewer as default };
