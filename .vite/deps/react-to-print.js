...
//#region node_modules/react-to-print/lib/index.js
var require_lib = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		return function() {
			...
			var r = {
				328: function(e, t, r) {
					Object.defineProperty(t, "__esModule", { value: !0 }), t.PrintContextConsumer = t.PrintContext = void 0;
					var n = r(496);
					t.PrintContext = Object.prototype.hasOwnProperty.call(n, "createContext") ? n.createContext({}) : null, t.PrintContextConsumer = t.PrintContext ? t.PrintContext.Consumer : function() {
						return null;
					};
				},
				428: function(e, t, r) {
					Object.defineProperty(t, "__esModule", { value: !0 }), t.ReactToPrint = void 0;
					var n = r(316), o = r(496), i = r(190), a = r(328), c = r(940);
					t.ReactToPrint = function(e) {
						function t() {
							...
							return t.startPrint = function(e) {
								...
								setTimeout((function() {
									...
									if (e.contentWindow) if (e.contentWindow.focus(), i) i(e).then((function() {
										...
										o ? o("print", e) : t.logMessages(["An error was thrown by the specified `print` function"]);
									}));
									else {
										...
										} else t.logMessages(["Printing for this browser is not currently possible: the browser does not have a `print` method available for iframes."]);
										n?.(), t.handleRemoveIframe();
									}
									else t.logMessages(["Printing failed because the `contentWindow` of the print iframe did not load. This is possibly an error with `react-to-print`. Please file an issue: https://github.com/gregnb/react-to-print/issues/"]);
								}), 500);
								...
								if (f && "function" == typeof a && t.logMessages(["\"react-to-print\" received a `content` prop and a content param passed the callback return by `useReactToPrint. The `content` prop will be ignored."], "warning"), f || "function" != typeof a || (f = a()), void 0 !== f) if (null !== f) {
									...
									if (p) {
										...
										var _ = function(e, r) {
											t.resourcesLoaded.includes(e) ? t.logMessages(["Tried to mark a resource that has already been handled", e], "debug") : (r ? (t.logMessages(n.__spreadArray(["\"react-to-print\" was unable to load a resource but will continue attempting to print the page"], n.__read(r), !1)), t.resourcesErrored.push(e)) : t.resourcesLoaded.push(e), t.resourcesLoaded.length + t.resourcesErrored.length === t.numResourcesToLoad && t.triggerPrint(d));
										};
										d.onload = function() {
											var e, r, i, a;
											d.onload = null;
											...
											if (f) {
												f.body.appendChild(h), s && ((null === (i = d.contentDocument) || void 0 === i ? void 0 : i.fonts) && (null === (a = d.contentWindow) || void 0 === a ? void 0 : a.FontFace) ? s.forEach((function(e) {
													...
													return _(e);
												})), t.logMessages(["\"react-to-print\" is not able to load custom fonts because the browser does not support the FontFace API but will continue attempting to print the page"])));
												var b = "function" == typeof u ? u() : u;
												if ("string" != typeof b) t.logMessages(["\"react-to-print\" expected a \"string\" from `pageStyle` but received \"".concat(typeof b, "\". Styles from `pageStyle` will not be applied.")]);
												else {
												...
												if (o && (e = f.body.classList).add.apply(e, n.__spreadArray([], n.__read(o.split(" ")), !1)), !y) {
													...
													var E = function(e) {
														...
														} else _(t, ["Found an <img> tag with an empty \"src\" attribute. This prevents pre-loading it. The <img> is:", t]);
													};
													...
													var T = function(e) {
														...
														if (r) {
															...
															return _(t, ["Loading video stalled, skipping", t]);
														});
													};
												...
												if (c) for (var F = document.querySelectorAll("style, link[rel~='stylesheet'], link[as='style']"), W = function(e, r) {
													...
													if ("style" === n.tagName.toLowerCase()) {
														...
														if (i) {
															...
															try {
																...
																t.logMessages(["A stylesheet could not be accessed. This is likely due to the stylesheet having cross-origin imports, and many browsers block script access to cross-origin stylesheets. See https://github.com/gregnb/react-to-print/issues/429 for details. You may be able to load the sheet by both marking the stylesheet with the cross `crossorigin` attribute, and setting the `Access-Control-Allow-Origin` header on the server serving the stylesheet. Alternatively, host the stylesheet on your domain to avoid this issue entirely.", n], "warning");
															}
															o.setAttribute("id", "react-to-print-".concat(e)), l && o.setAttribute("nonce", l), o.appendChild(f.createTextNode(a)), f.head.appendChild(o);
														}
													} else if (n.getAttribute("href")) if (n.hasAttribute("disabled")) t.logMessages(["`react-to-print` encountered a <link> tag with a `disabled` attribute and will ignore it. Note that the `disabled` attribute is deprecated, and some browsers ignore it. You should stop using it. https://developer.mozilla.org/en-US/docs/Web/HTML/Element/link#attr-disabled. The <link> is:", n], "warning"), _(n);
													else {
													...
													else t.logMessages(["`react-to-print` encountered a <link> tag with an empty `href` attribute. In addition to being invalid HTML, this can cause problems in many browsers, and so the <link> was not loaded. The <link> is:", n], "warning"), _(n);
												}, L = (O = 0, F.length); O < L; ++O) W(O);
											}
											0 !== t.numResourcesToLoad && c || t.triggerPrint(d);
										}, t.handleRemoveIframe(!0), document.body.appendChild(d);
									} else t.logMessages(["\"react-to-print\" could not locate the DOM node corresponding with the `content` prop"]);
								} else t.logMessages(["There is nothing to print because the \"content\" prop returned \"null\". Please ensure \"content\" is renderable before allowing \"react-to-print\" to be called."]);
								else t.logMessages(["To print a functional component ensure it is wrapped with `React.forwardRef`, and ensure the forwarded ref is used. See the README for an example: https://github.com/gregnb/react-to-print#examples"]);
						...
						return n.__extends(t, e), t.prototype.handleClick = function(e, t) {
							...
							if (r) return o.cloneElement(r(), { onClick: this.handleClick.bind(this) });
							if (!a.PrintContext) return this.logMessages(["\"react-to-print\" requires React ^16.3.0 to be able to use \"PrintContext\""]), null;
							var n = { handlePrint: this.handleClick.bind(this) };
							return o.createElement(a.PrintContext.Provider, { value: n }, t);
						}, t.defaultProps = c.defaultProps, t;
					}(o.Component);
				},
				940: function(e, t) {
					Object.defineProperty(t, "__esModule", { value: !0 }), t.defaultProps = void 0, t.defaultProps = {
						copyStyles: !0,
				...
				892: function(e, t, r) {
					Object.defineProperty(t, "__esModule", { value: !0 }), t.useReactToPrint = void 0;
				...
				860: function(e, t, r) {
					Object.defineProperty(t, "__esModule", { value: !0 }), t.wrapCallbackWithArgs = void 0;
					var n = r(316);
			...
			return function() {
				var e = i;
				Object.defineProperty(e, "__esModule", { value: !0 }), e.useReactToPrint = e.ReactToPrint = e.PrintContextConsumer = void 0;
				var t = o(328);
