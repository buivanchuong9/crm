//#region node_modules/ssr-window/ssr-window.esm.js
/**
* SSR Window 4.0.2
...
//#endregion
//#region node_modules/dom7/dom7.esm.js
/**
* Dom7 4.0.6
...
function attr(attrs, value) {
	...
	for (let i = 0; i < this.length; i += 1) if (arguments.length === 2) this[i].setAttribute(attrs, value);
...
function shortcut(name) {
	function eventHandler(...args) {
		if (typeof args[0] === "undefined") {
			for (let i = 0; i < this.length; i += 1) if (noTrigger.indexOf(name) < 0) if (name in this[i]) this[i][name]();
...
shortcut("scroll");
//#endregion
//#region node_modules/swiper/shared/dom.js
var Methods = {
	addClass,
	removeClass,
	hasClass,
...
var dom_default = $;
//#endregion
//#region node_modules/swiper/shared/utils.js
...
//#endregion
//#region node_modules/swiper/shared/get-support.js
var support;
...
//#endregion
//#region node_modules/swiper/shared/get-device.js
var deviceCached;
...
//#endregion
//#region node_modules/swiper/shared/get-browser.js
var browser;
...
//#endregion
//#region node_modules/swiper/core/modules/resize/resize.js
...
//#endregion
//#region node_modules/swiper/core/modules/observer/observer.js
function Observer({ swiper, extendParams, on, emit }) {
	...
	const init = () => {
		...
		attach(swiper.$el[0], { childList: swiper.params.observeSlideChildren });
...
//#endregion
//#region node_modules/swiper/core/events-emitter.js
...
//#endregion
//#region node_modules/swiper/core/update/updateSize.js
function updateSize() {
	const swiper = this;
	let width;
	let height;
...
//#endregion
//#region node_modules/swiper/core/update/updateSlides.js
...
//#endregion
//#region node_modules/swiper/core/update/updateAutoHeight.js
function updateAutoHeight(speed) {
	...
	if (swiper.params.slidesPerView !== "auto" && swiper.params.slidesPerView > 1) if (swiper.params.centeredSlides) swiper.visibleSlides.each((slide) => {
...
//#endregion
//#region node_modules/swiper/core/update/updateSlidesOffset.js
...
//#endregion
//#region node_modules/swiper/core/update/updateSlidesProgress.js
function updateSlidesProgress(translate = this && this.translate || 0) {
	...
	for (let i = 0; i < slides.length; i += 1) {
		...
		if (slideBefore >= 0 && slideBefore < swiper.size - 1 || slideAfter > 1 && slideAfter <= swiper.size || slideBefore <= 0 && slideAfter >= swiper.size) {
...
//#endregion
//#region node_modules/swiper/core/update/updateProgress.js
...
//#endregion
//#region node_modules/swiper/core/update/updateSlidesClasses.js
...
//#endregion
//#region node_modules/swiper/core/update/updateActiveIndex.js
...
//#endregion
//#region node_modules/swiper/core/update/updateClickedSlide.js
function updateClickedSlide(e) {
	...
	if (slide && slideFound) {
		...
		if (swiper.virtual && swiper.params.virtual.enabled) swiper.clickedIndex = parseInt(dom_default(slide).attr("data-swiper-slide-index"), 10);
...
//#endregion
//#region node_modules/swiper/core/update/index.js
var update_default = {
	updateSize,
	updateSlides,
	updateAutoHeight,
...
//#endregion
//#region node_modules/swiper/core/translate/getTranslate.js
...
//#endregion
//#region node_modules/swiper/core/translate/setTranslate.js
...
//#endregion
//#region node_modules/swiper/core/translate/minTranslate.js
function minTranslate() {
	return -this.snapGrid[0];
}
//#endregion
//#region node_modules/swiper/core/translate/maxTranslate.js
function maxTranslate() {
	return -this.snapGrid[this.snapGrid.length - 1];
}
//#endregion
//#region node_modules/swiper/core/translate/translateTo.js
...
//#endregion
//#region node_modules/swiper/core/translate/index.js
...
//#endregion
//#region node_modules/swiper/core/transition/setTransition.js
...
//#endregion
//#region node_modules/swiper/core/transition/transitionEmit.js
...
//#endregion
//#region node_modules/swiper/core/transition/transitionStart.js
...
//#endregion
//#region node_modules/swiper/core/transition/transitionEnd.js
...
//#endregion
//#region node_modules/swiper/core/transition/index.js
...
//#endregion
//#region node_modules/swiper/core/slide/slideTo.js
...
//#endregion
//#region node_modules/swiper/core/slide/slideToLoop.js
...
//#endregion
//#region node_modules/swiper/core/slide/slideNext.js
...
//#endregion
//#region node_modules/swiper/core/slide/slidePrev.js
function slidePrev(speed = this.params.speed, runCallbacks = true, internal) {
	...
	let prevSnap = snapGrid[snapGrid.map((val) => normalize(val)).indexOf(normalizedTranslate) - 1];
...
//#endregion
//#region node_modules/swiper/core/slide/slideReset.js
function slideReset(speed = this.params.speed, runCallbacks = true, internal) {
	const swiper = this;
	return swiper.slideTo(swiper.activeIndex, speed, runCallbacks, internal);
}
//#endregion
//#region node_modules/swiper/core/slide/slideToClosest.js
...
//#endregion
//#region node_modules/swiper/core/slide/slideToClickedSlide.js
...
//#endregion
//#region node_modules/swiper/core/slide/index.js
var slide_default = {
	slideTo,
	slideToLoop,
	slideNext,
...
//#endregion
//#region node_modules/swiper/core/loop/loopCreate.js
function loopCreate() {
	const swiper = this;
	const document = getDocument();
	const { params, $wrapperEl } = swiper;
	...
	for (let i = 0; i < appendSlides.length; i += 1) $selector.append(dom_default(appendSlides[i].cloneNode(true)).addClass(params.slideDuplicateClass));
	for (let i = prependSlides.length - 1; i >= 0; i -= 1) $selector.prepend(dom_default(prependSlides[i].cloneNode(true)).addClass(params.slideDuplicateClass));
}
//#endregion
//#region node_modules/swiper/core/loop/loopFix.js
function loopFix() {
	const swiper = this;
	...
	if (activeIndex < loopedSlides) {
		...
		if (swiper.slideTo(newIndex, 0, false, true) && diff !== 0) swiper.setTranslate((rtl ? -swiper.translate : swiper.translate) - diff);
...
//#endregion
//#region node_modules/swiper/core/loop/loopDestroy.js
...
//#endregion
//#region node_modules/swiper/core/loop/index.js
var loop_default = {
	loopCreate,
	loopFix,
	loopDestroy
...
//#endregion
//#region node_modules/swiper/core/grab-cursor/setGrabCursor.js
...
//#endregion
//#region node_modules/swiper/core/grab-cursor/unsetGrabCursor.js
...
//#endregion
//#region node_modules/swiper/core/grab-cursor/index.js
var grab_cursor_default = {
	setGrabCursor,
	unsetGrabCursor
};
//#endregion
//#region node_modules/swiper/core/events/onTouchStart.js
function closestElement(selector, base = this) {
	function __closestFrom(el) {
		if (!el || el === getDocument() || el === getWindow()) return null;
		if (el.assignedSlot) el = el.assignedSlot;
		return el.closest(selector) || __closestFrom(el.getRootNode().host);
	}
...
function onTouchStart(event) {
	...
	if (!!params.noSwipingClass && params.noSwipingClass !== "" && e.target && e.target.shadowRoot && event.path && event.path[0]) $targetEl = dom_default(event.path[0]);
	...
	if (edgeSwipeDetection && (startX <= edgeSwipeThreshold || startX >= window.innerWidth - edgeSwipeThreshold)) if (edgeSwipeDetection === "prevent") event.preventDefault();
	else return;
	Object.assign(data, {
		isTouched: true,
		isMoved: false,
	...
	if (e.type !== "touchstart") {
		...
		if (document.activeElement && dom_default(document.activeElement).is(data.focusableElements) && document.activeElement !== $targetEl[0]) document.activeElement.blur();
...
//#endregion
//#region node_modules/swiper/core/events/onTouchMove.js
...
//#endregion
//#region node_modules/swiper/core/events/onTouchEnd.js
...
//#endregion
//#region node_modules/swiper/core/events/onResize.js
function onResize() {
	const swiper = this;
...
//#endregion
//#region node_modules/swiper/core/events/onClick.js
function onClick(e) {
	const swiper = this;
...
//#endregion
//#region node_modules/swiper/core/events/onScroll.js
function onScroll() {
	const swiper = this;
...
//#endregion
//#region node_modules/swiper/core/events/index.js
...
//#endregion
//#region node_modules/swiper/core/breakpoints/setBreakpoint.js
...
//#endregion
//#region node_modules/swiper/core/breakpoints/getBreakpoint.js
...
//#endregion
//#region node_modules/swiper/core/breakpoints/index.js
var breakpoints_default = {
	setBreakpoint,
	getBreakpoint
};
//#endregion
//#region node_modules/swiper/core/classes/addClasses.js
...
//#endregion
//#region node_modules/swiper/core/classes/removeClasses.js
...
//#endregion
//#region node_modules/swiper/core/classes/index.js
var classes_default = {
	addClasses,
	removeClasses
};
//#endregion
//#region node_modules/swiper/core/images/loadImage.js
function loadImage(imageEl, src, srcset, sizes, checkForComplete, callback) {
	...
	if (!dom_default(imageEl).parent("picture")[0] && (!imageEl.complete || !checkForComplete)) if (src) {
...
//#endregion
//#region node_modules/swiper/core/images/preloadImages.js
...
//#endregion
//#region node_modules/swiper/core/images/index.js
var images_default = {
	loadImage,
	preloadImages
};
//#endregion
//#region node_modules/swiper/core/check-overflow/index.js
...
var check_overflow_default = { checkOverflow };
//#endregion
//#region node_modules/swiper/core/defaults.js
...
//#endregion
//#region node_modules/swiper/core/moduleExtendParams.js
function moduleExtendParams(params, allModulesParams) {
	return function extendParams(obj = {}) {
		...
		if ([
			...
			"pagination",
			"scrollbar"
		].indexOf(moduleParamName) >= 0 && params[moduleParamName] === true) params[moduleParamName] = { auto: true };
...
//#endregion
//#region node_modules/swiper/core/core.js
var prototypes = {
...
var Swiper = class Swiper {
	constructor(...args) {
		...
		swiper.params = extend({}, extend({}, defaults_default, allModulesParams), extendedDefaults, params);
...
//#endregion
//#region node_modules/swiper/modules/virtual/virtual.js
function Virtual({ swiper, extendParams, on }) {
	...
	function renderSlide(slide, index) {
		...
		const $slideEl = params.renderSlide ? dom_default(params.renderSlide.call(swiper, slide, index)) : dom_default(`<div class="${swiper.params.slideClass}" data-swiper-slide-index="${index}">${slide}</div>`);
	...
	function update(force) {
		...
		else for (let i = previousFrom; i <= previousTo; i += 1) if (i < from || i > to) swiper.$wrapperEl.find(`.${swiper.params.slideClass}[data-swiper-slide-index="${i}"]`).remove();
		for (let i = 0; i < slides.length; i += 1) if (i >= from && i <= to) if (typeof previousTo === "undefined" || force) appendIndexes.push(i);
		else {
...
//#endregion
//#region node_modules/swiper/modules/keyboard/keyboard.js
...
//#endregion
//#region node_modules/swiper/modules/mousewheel/mousewheel.js
function Mousewheel({ swiper, extendParams, on, emit }) {
	...
	function handle(event) {
		...
		if (swiper.params.mousewheel.eventsTarget !== "container") target = dom_default(swiper.params.mousewheel.eventsTarget);
...
//#endregion
//#region node_modules/swiper/shared/create-element-if-not-defined.js
...
//#endregion
//#region node_modules/swiper/modules/navigation/navigation.js
...
//#endregion
//#region node_modules/swiper/shared/classes-to-selector.js
function classesToSelector(classes = "") {
	return `.${classes.trim().replace(/([\.:!\/])/g, "\\$1").replace(/ /g, ".")}`;
}
//#endregion
//#region node_modules/swiper/modules/pagination/pagination.js
function Pagination({ swiper, extendParams, on, emit }) {
	...
	function init() {
		...
		if (params.clickable) $el.on("click", classesToSelector(params.bulletClass), function onClick(e) {
			e.preventDefault();
			let index = dom_default(this).index() * swiper.params.slidesPerGroup;
	...
	on("click", (_s, e) => {
		...
		if (swiper.params.pagination.el && swiper.params.pagination.hideOnClick && $el.length > 0 && !dom_default(targetEl).hasClass(swiper.params.pagination.bulletClass)) {
			...
			if ($el.hasClass(swiper.params.pagination.hiddenClass) === true) emit("paginationShow");
...
//#endregion
//#region node_modules/swiper/modules/scrollbar/scrollbar.js
...
//#endregion
//#region node_modules/swiper/modules/parallax/parallax.js
...
//#endregion
//#region node_modules/swiper/modules/zoom/zoom.js
function Zoom({ swiper, extendParams, on, emit }) {
	...
	Object.defineProperty(swiper.zoom, "scale", {
		...
		set(value) {
			if (scale !== value) emit("zoomChange", value, gesture.$imageEl ? gesture.$imageEl[0] : void 0, gesture.$slideEl ? gesture.$slideEl[0] : void 0);
			scale = value;
		}
	});
	...
	function zoomIn(e) {
		...
		const params = swiper.params.zoom;
		if (!gesture.$slideEl) {
			if (e && e.target) gesture.$slideEl = dom_default(e.target).closest(`.${swiper.params.slideClass}`);
			if (!gesture.$slideEl) if (swiper.params.virtual && swiper.params.virtual.enabled && swiper.virtual) gesture.$slideEl = swiper.$wrapperEl.children(`.${swiper.params.slideActiveClass}`);
	...
	function getListeners() {
		const support = swiper.support;
		return {
			passiveListener: swiper.touchEvents.start === "touchstart" && support.passiveListener && swiper.params.passiveListeners ? {
				passive: true,
				capture: false
			} : false,
...
//#endregion
//#region node_modules/swiper/modules/lazy/lazy.js
function Lazy({ swiper, extendParams, on, emit }) {
		...
		$images.each((imageEl) => {
			...
			swiper.loadImage($imageEl[0], src || background, srcset, sizes, false, () => {
				...
				if (swiper.params.loop && loadInDuplicate) {
					...
					if ($slideEl.hasClass(swiper.params.slideDuplicateClass)) loadInSlide(swiper.$wrapperEl.children(`[data-swiper-slide-index="${slideOriginalIndex}"]:not(.${swiper.params.slideDuplicateClass})`).index(), false);
					else loadInSlide(swiper.$wrapperEl.children(`.${swiper.params.slideDuplicateClass}[data-swiper-slide-index="${slideOriginalIndex}"]`).index(), false);
				}
	...
	function load() {
		...
		function slideIndex(slideEl) {
			if (isVirtual) return dom_default(slideEl).attr("data-swiper-slide-index");
			return dom_default(slideEl).index();
		}
		if (!initialImageLoaded) initialImageLoaded = true;
		if (swiper.params.watchSlidesProgress) $wrapperEl.children(`.${swiperParams.slideVisibleClass}`).each((slideEl) => {
			loadInSlide(isVirtual ? dom_default(slideEl).attr("data-swiper-slide-index") : dom_default(slideEl).index());
		});
	...
	function checkInViewOnLoad() {
		const window = getWindow();
		if (!swiper || swiper.destroyed) return;
		const $scrollElement = swiper.params.lazy.scrollingElement ? dom_default(swiper.params.lazy.scrollingElement) : dom_default(window);
	...
	on("init", () => {
		if (swiper.params.lazy.enabled) if (swiper.params.lazy.checkInView) checkInViewOnLoad();
		else load();
	});
	on("scroll", () => {
	...
	on("transitionStart", () => {
		if (swiper.params.lazy.enabled) {
			if (swiper.params.lazy.loadOnTransitionStart || !swiper.params.lazy.loadOnTransitionStart && !initialImageLoaded) if (swiper.params.lazy.checkInView) checkInViewOnLoad();
			else load();
		}
	});
	on("transitionEnd", () => {
		if (swiper.params.lazy.enabled && !swiper.params.lazy.loadOnTransitionStart) if (swiper.params.lazy.checkInView) checkInViewOnLoad();
		else load();
	});
	on("slideChange", () => {
...
//#endregion
//#region node_modules/swiper/modules/controller/controller.js
...
//#endregion
//#region node_modules/swiper/modules/a11y/a11y.js
function A11y({ swiper, extendParams, on }) {
	...
	function init() {
		...
		if (params.itemRoleDescriptionMessage) addElRoleDescription(dom_default(swiper.slides), params.itemRoleDescriptionMessage);
...
//#endregion
//#region node_modules/swiper/modules/history/history.js
function History({ swiper, extendParams, on }) {
	...
	const setHistory = (key, index) => {
		...
		let value = slugify(swiper.slides.eq(index).attr("data-history"));
...
//#endregion
//#region node_modules/swiper/modules/hash-navigation/hash-navigation.js
function HashNavigation({ swiper, extendParams, emit, on }) {
	...
	const init = () => {
		...
		if (swiper.params.hashNavigation.watchState) dom_default(window).on("hashchange", onHashChange);
	};
	const destroy = () => {
		if (swiper.params.hashNavigation.watchState) dom_default(window).off("hashchange", onHashChange);
	};
	on("init", () => {
...
//#endregion
//#region node_modules/swiper/modules/autoplay/autoplay.js
function Autoplay({ swiper, extendParams, on, emit }) {
	...
	on("beforeTransitionStart", (_s, speed, internal) => {
		if (swiper.autoplay.running) if (internal || !swiper.params.autoplay.disableOnInteraction) swiper.autoplay.pause(speed);
		else stop();
	});
	on("sliderFirstMove", () => {
		if (swiper.autoplay.running) if (swiper.params.autoplay.disableOnInteraction) stop();
		else pause();
	});
	on("touchEnd", () => {
...
//#endregion
//#region node_modules/swiper/modules/thumbs/thumbs.js
function Thumb({ swiper, extendParams, on }) {
	...
	function onThumbClick() {
		...
		let slideToIndex;
		if (thumbsSwiper.params.loop) slideToIndex = parseInt(dom_default(thumbsSwiper.clickedSlide).attr("data-swiper-slide-index"), 10);
...
//#endregion
//#region node_modules/swiper/modules/free-mode/free-mode.js
...
//#endregion
//#region node_modules/swiper/modules/grid/grid.js
...
//#endregion
//#region node_modules/swiper/modules/manipulation/methods/appendSlide.js
function appendSlide(slides) {
	const swiper = this;
...
//#endregion
//#region node_modules/swiper/modules/manipulation/methods/prependSlide.js
function prependSlide(slides) {
	const swiper = this;
...
//#endregion
//#region node_modules/swiper/modules/manipulation/methods/addSlide.js
...
//#endregion
//#region node_modules/swiper/modules/manipulation/methods/removeSlide.js
function removeSlide(slidesIndexes) {
	const swiper = this;
	const { params, $wrapperEl, activeIndex } = swiper;
	let activeIndexBuffer = activeIndex;
...
//#endregion
//#region node_modules/swiper/modules/manipulation/methods/removeAllSlides.js
function removeAllSlides() {
	const swiper = this;
	const slidesIndexes = [];
...
//#endregion
//#region node_modules/swiper/modules/manipulation/manipulation.js
...
//#endregion
//#region node_modules/swiper/shared/effect-init.js
...
//#endregion
//#region node_modules/swiper/shared/effect-target.js
...
//#endregion
//#region node_modules/swiper/shared/effect-virtual-transition-end.js
...
//#endregion
//#region node_modules/swiper/modules/effect-fade/effect-fade.js
function EffectFade({ swiper, extendParams, on }) {
	...
	const setTranslate = () => {
		...
		for (let i = 0; i < slides.length; i += 1) {
			...
			effectTarget(params, $slideEl).css({ opacity: slideOpacity }).transform(`translate3d(${tx}px, ${ty}px, 0px)`);
		}
	};
	const setTransition = (duration) => {
		const { transformEl } = swiper.params.fadeEffect;
		(transformEl ? swiper.slides.find(transformEl) : swiper.slides).transition(duration);
...
//#endregion
//#region node_modules/swiper/modules/effect-cube/effect-cube.js
function EffectCube({ swiper, extendParams, on }) {
	...
	const setTranslate = () => {
		...
		if (params.shadow) if (isHorizontal) $cubeShadowEl.transform(`translate3d(0px, ${swiperWidth / 2 + params.shadowOffset}px, ${-swiperWidth / 2}px) rotateX(90deg) rotateZ(0deg) scale(${params.shadowScale})`);
		else {
...
//#endregion
//#region node_modules/swiper/shared/create-shadow.js
...
//#endregion
//#region node_modules/swiper/modules/effect-flip/effect-flip.js
...
//#endregion
//#region node_modules/swiper/modules/effect-coverflow/effect-coverflow.js
function EffectCoverflow({ swiper, extendParams, on }) {
	...
	const setTranslate = () => {
		...
		for (let i = 0, length = slides.length; i < length; i += 1) {
			...
			const offsetMultiplier = (center - $slideEl[0].swiperSlideOffset - slideSize / 2) / slideSize * params.modifier;
...
//#endregion
//#region node_modules/swiper/modules/effect-creative/effect-creative.js
function EffectCreative({ swiper, extendParams, on }) {
	...
	const setTransition = (duration) => {
		...
		(transformEl ? swiper.slides.find(transformEl) : swiper.slides).transition(duration).find(".swiper-slide-shadow").transition(duration);
		effectVirtualTransitionEnd({
			swiper,
			duration,
			transformEl,
...
//#endregion
//#region node_modules/swiper/modules/effect-cards/effect-cards.js
function EffectCards({ swiper, extendParams, on }) {
	...
	const setTranslate = () => {
		...
		for (let i = 0; i < slides.length; i += 1) {
			...
			let tXAdd = 8 - Math.abs(progress) * .75;
...
//#endregion
export { Keyboard as C, Mousewheel as S, Swiper as T, Zoom as _, EffectCube as a, Pagination as b, Grid as c, Autoplay as d, HashNavigation as f, Lazy as g, Controller as h, EffectFlip as i, freeMode as l, A11y as m, EffectCreative as n, EffectFade as o, History as p, EffectCoverflow as r, Manipulation as s, EffectCards as t, Thumb as u, Parallax as v, Virtual as w, Navigation as x, Scrollbar as y };

//# sourceMappingURL=swiper.esm-BKZGVc9A.js.map