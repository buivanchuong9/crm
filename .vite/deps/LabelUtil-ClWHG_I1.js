import { assign, filter, find, forEach, has, isArray, isFunction, isNumber, isObject, some } from "./min-dash.js";
import { d as query, i as classes$1, s as delegate, t as all } from "./index.esm-E5VQvuu4.js";
...
function InteractionEvents(eventBus, elementRegistry, styles) {
	...
	*/
	this.removeHits = function(gfx) {
		forEach(all(".djs-hit", gfx), remove);
	};
	/**
...
function eachElement(elements, fn, depth) {
	...
	forEach(elements, function(s, i) {
		...
		if (isArray(filter) && filter.length) eachElement(filter, fn, depth + 1);
	});
}
/**
...
Outline.prototype.updateShapeOutline = function(outline, element) {
	...
	if (providers.length) forEach(providers, function(provider) {
...
Outline.prototype.getOutline = function(element) {
	var outline;
	forEach(this._getProviders(), function(provider) {
		if (!isFunction(provider.getOutline)) return;
...
Selection.prototype.select = function(elements, add) {
	...
	if (add) forEach(elements, function(element) {
...
function SelectionBehavior(eventBus, selection, canvas, elementRegistry) {
	eventBus.on("create.end", 500, function(event) {
		...
		if (canExecute) {
			...
			if (isArray(autoSelect)) selection.select(autoSelect);
	...
	eventBus.on("shape.move.end", 500, function(event) {
		...
		if (!find(previousSelection, function(selectedShape) {
...
//#endregion
export { attr as A, stopPropagation as B, getBBox as C, componentsToPath as D, isFrameElement as E, innerSVG as F, remove as I, transform$1 as L, clone as M, create as N, createLine as O, createMatrix as P, isMac as R, eachElement as S, getType as T, toPoint as V, install as _, getDi as a, selection_default as b, rotate as c, isConnection as d, isLabel as f, delta as g, getVisual as h, getBusinessObject as i, classes as j, append as k, transform as l, getChildren as m, getLabel as n, is as o, IdGenerator as p, isLabelExternal as r, isAny as s, getExternalLabelBounds as t, translate as u, set as v, getParents as w, outline_default as x, unset as y, getOriginal as z };

//# sourceMappingURL=LabelUtil-ClWHG_I1.js.map