import { C as isIndexedDBAvailable, S as getModularInstance, b as FirebaseError, c as _getProvider, f as getApp, g as registerVersion, l as _registerComponent, v as Component, w as validateIndexedDBOpenable, x as areCookiesEnabled, y as ErrorFactory } from "./index.esm2017-BURzI3Oe.js";
...
var cursorRequestMap$1 = /* @__PURE__ */ new WeakMap();
var transactionDoneMap$1 = /* @__PURE__ */ new WeakMap();
var transactionStoreNamesMap$1 = /* @__PURE__ */ new WeakMap();
var transformCache$1 = /* @__PURE__ */ new WeakMap();
var reverseTransformCache$1 = /* @__PURE__ */ new WeakMap();
function promisifyRequest$1(request) {
	...
	promise.then((value) => {
		if (value instanceof IDBCursor) cursorRequestMap$1.set(value, request);
	}).catch(() => {});
...
var idbProxyTraps$1 = {
	get(target, prop, receiver) {
		if (target instanceof IDBTransaction) {
			...
			if (prop === "objectStoreNames") return target.objectStoreNames || transactionStoreNamesMap$1.get(target);
...
var unwrap$1 = (value) => reverseTransformCache$1.get(value);
//#endregion
...
var cachedMethods$1 = /* @__PURE__ */ new Map();
...
function getDbPromise$1() {
	if (!dbPromise$1) dbPromise$1 = openDB$1(DATABASE_NAME$1, DATABASE_VERSION$1, { upgrade: (db, oldVersion) => {
		switch (oldVersion) {
...
//#endregion
//#region node_modules/@firebase/messaging/node_modules/idb/build/wrap-idb-value.js
...
//#endregion
//#region node_modules/@firebase/messaging/node_modules/idb/build/index.js
/**
* Open a database.
*
* @param name Name of the database.
