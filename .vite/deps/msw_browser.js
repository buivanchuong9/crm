import { B as devUtils, L as Emitter$1, M as Interceptor$1, N as createRequestId$1, O as BatchInterceptor, R as TypedEvent$1, T as HttpResponse, V as invariant$1, c as toReadonlyArray, d as InMemoryHandlersController, h as kConnect, i as until$1, j as DeferredPromise$1, k as resolveWebSocketUrl$1, l as Disposable, m as kAutoConnect, r as isCommonAssetRequest, s as executeHandlers, t as storeResponseCookies, u as HandlersController, v as isObject, w as RequestHandler, y as toPublicUrl, z as InternalError } from "./storeResponseCookies-DivfBIHR.js";
...
Please consider using a custom "serviceWorker.url" option to point to the actual worker script location, or a custom "findWorker" option to resolve the Service Worker registration manually. More details: https://mswjs.io/docs/api/setup-worker/start`, workerUrl, location.host);
	...
	async #checkWorkerIntegrity() {
		...
		this.#channel.once("INTEGRITY_CHECK_RESPONSE", (event) => {
			...
			if (checksum !== "4db4a41e972cec1b64cc569c66952d82") devUtils.warn(`The currently registered Service Worker has been generated by a different version of MSW (${packageVersion}) and may not be fully compatible with the installed version.
