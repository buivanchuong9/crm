...
function P(n, l, u, t, i) {
	...
	for (n.__k = new Array(i), r = 0; r < i; r++) null != (o = l[r]) && "boolean" != typeof o && "function" != typeof o ? (f = r + h, (o = n.__k[r] = "string" == typeof o || "number" == typeof o || "bigint" == typeof o || o.constructor == String ? m(null, o, null, null, null) : w(o) ? m(k, { children: o }, null, null, null) : null == o.constructor && o.__b > 0 ? m(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v) : o).__ = n, o.__b = n.__b + 1, e = null, -1 != (c = o.__i = L(o, u, f, a)) && (a--, (e = u[c]) && (e.__u |= 2)), null == e || null == e.__v ? (-1 == c && (i > s ? h-- : i < s && h++), "function" != typeof o.type && (o.__u |= 4)) : c != f && (c == f - 1 ? h-- : c == f + 1 ? h++ : (c > f ? h-- : h++, o.__u |= 4))) : n.__k[r] = null;
...
function q(u, t, i, r, o, e, f, c, s) {
	...
	if (null == x) b === k || c && u.data == k || (u.data = k);
		...
		else if (v && (u.innerHTML = ""), I("template" == t.type ? u.content : u, w(y) ? y : [y], t, i, r, "foreignObject" == x ? "http://www.w3.org/1999/xhtml" : o, e, f, e ? e[0] : i.__k && S(i, 0), c, s), null != e) for (a = e.length; a--;) g(e[a]);
...
n = v.slice, l = { __e: function(n, l, u, t) {
	...
	var u = null != this.__s && this.__s != this.state ? this.__s : this.__s = d({}, this.state);
	"function" == typeof n && (n = n(d({}, u), this.props)), n && d(u, n), null != n && this.__v && (l && this._sb.push(l), M(this));
...
//#endregion
export { x as Component, k as Fragment, K as cloneElement, Q as createContext, _ as createElement, _ as h, b as createRef, J as hydrate, t as isValidElement, l as options, G as render, H as toChildArray };
