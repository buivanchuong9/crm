...
function QRCodeCanvas(props) {
	...
	return /* @__PURE__ */ import_react.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.createElement("canvas", __spreadValues({
		style: canvasStyle,
		height: size,
		width: size,
		ref: _canvas
...
function QRCodeSVG(props) {
	...
	}, otherProps), /* @__PURE__ */ import_react.createElement("path", {
		fill: bgColor,
...
var QRCode = (props) => {
	...
	if (renderAs === "svg") return /* @__PURE__ */ import_react.createElement(QRCodeSVG, __spreadValues({}, otherProps));
	return /* @__PURE__ */ import_react.createElement(QRCodeCanvas, __spreadValues({}, otherProps));
};
//#endregion
