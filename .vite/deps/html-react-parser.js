...
var require_node = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var domelementtype_1 = require_lib$2();
	/**
...
var require_domparser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var HTML = "html";
	var HEAD = "head";
	var BODY = "body";
 ...
 /**
	...
	*/
	function domparser(html) {
		...
		if (match && match[1]) firstTagName = match[1].toLowerCase();
		var doc;
		var element;
		var elements;
		switch (firstTagName) {
...
var require_utilities$2 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var domhandler = require_lib$1();
	var CASE_SENSITIVE_TAG_NAMES = require_constants().CASE_SENSITIVE_TAG_NAMES;
	...
	*/
	function formatDOM(nodes, parent, directive) {
		...
		if (directive) {
			...
			if (result[1]) result[1].prev = result[0];
		}
		return result;
	}
...
var require_html_to_dom = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var domparser = require_domparser();
	var formatDOM = require_utilities$2().formatDOM;
	...
	*/
	function HTMLDOMParser(html) {
		...
		var directive;
		if (match && match[1]) directive = match[1];
...
var require_lib = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var _require = require_possibleStandardNamesOptimized(), CAMELCASE = _require.CAMELCASE, SAME = _require.SAME, possibleStandardNamesOptimized = _require.possibleStandardNames;
	/**
...
//#endregion
//#region node_modules/style-to-object/index.js
var require_style_to_object = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_utilities = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function isCustomComponent(tagName, props) {
		if (tagName.indexOf("-") === -1) return props && typeof props.is === "string";
		switch (tagName) {
			case "annotation-xml":
			case "color-profile":
			case "font-face":
...
var require_attributes_to_props = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = function attributesToProps(attributes, nodeName) {
		...
		for (attributeName in attributes) {
			...
			if (propName) {
				...
				if (UNCONTROLLED_COMPONENT_ATTRIBUTES.indexOf(propName) !== -1 && UNCONTROLLED_COMPONENT_NAMES.indexOf(nodeName) !== -1 && !inputIsValueOnly) propName = getPropName("default" + attributeNameLowerCased);
...
var require_dom_to_react = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var React = require_react();
		...
		for (var i = 0, len = nodes.length; i < len; i++) {
			...
			if (hasReplace) {
				...
				if (isValidElement(replaceElement)) {
					if (len > 1) replaceElement = cloneElement(replaceElement, { key: replaceElement.key || i });
			...
			if (node.type === "text") {
				...
				if (isWhitespace && node.parent && !canTextBeChildOfNode(node.parent)) continue;
				if (trim && isWhitespace) continue;
				result.push(node.data);
				continue;
			}
			props = node.attribs;
			if (skipAttributesToProps(node)) setStyleProp(props.style, props);
			else if (props) props = attributesToProps(props, node.name);
			children = null;
			switch (node.type) {
				case "script":
				case "style":
				...
				case "tag":
					...
					else if (node.children && node.children.length) children = domToReact(node.children, options);
					break;
				default: continue;
			}
...
//#endregion
//#region node_modules/html-react-parser/index.mjs
var import_html_react_parser = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	var domhandler = require_lib$1();
...
var domToReact = import_html_react_parser.default.domToReact;
var htmlToDOM = import_html_react_parser.default.htmlToDOM;
var attributesToProps = import_html_react_parser.default.attributesToProps;
var Comment = import_html_react_parser.default.Comment;
var Element = import_html_react_parser.default.Element;
var ProcessingInstruction = import_html_react_parser.default.ProcessingInstruction;
var Text = import_html_react_parser.default.Text;
var html_react_parser_default = import_html_react_parser.default;
//#endregion
export { Comment, Element, ProcessingInstruction, Text, attributesToProps, html_react_parser_default as default, domToReact, htmlToDOM };
