	...
	(function() {
		...
		*/
		function jsxDEV(type, config, maybeKey, source, self) {
			...
			var key = null;
			var ref = null;
			if (maybeKey !== void 0) key = "" + maybeKey;
		...
		*/
		function validateExplicitKey(element, parentType) {
			...
			var childOwner = "";
			if (element && element._owner && element._owner !== ReactCurrentOwner$1.current) childOwner = " It was passed a child from " + getComponentName(element._owner.type) + ".";
		...
		*/
		...
		function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
			...
			if (validType) {
				...
				if (children !== void 0) if (isStaticChildren) if (Array.isArray(children)) {
		...
		exports.jsxDEV = jsxWithValidation;
	})();
}));
//#endregion
