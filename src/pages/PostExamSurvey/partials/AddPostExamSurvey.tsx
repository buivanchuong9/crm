...
import { IAddPostExamSurveyProps } from "model/surveyForm/PropsModel";
...
import "./AddPostExamSurvey.scss";

export default function AddPostExamSurvey(props: IAddPostExamSurveyProps) {
