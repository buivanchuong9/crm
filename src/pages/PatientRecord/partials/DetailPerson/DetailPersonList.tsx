...
import AddWorkModal from "pages/DailyProgressLog/partials/ListWork/partials/AddWorkModal/AddWorkModal";
...
import AddConsultationScheduleModal from "pages/ClinicCalendar/partials/AddConsultationScheduleModal/AddConsultationScheduleModal";
import AddPhoneModal from "pages/DoctorQnA/partials/AddPhoneModal";
...
export default function DetailPersonList() {
  document.title = "Chi tiết Hồ sơ Bệnh án";
  ...
  const backScreenList = () => {
    navigate(`/customer?contactType=${takeUrlCustomerLocalStorage.contactType}&page=${takeUrlCustomerLocalStorage?.page || 1}&limit=${takeUrlCustomerLocalStorage?.limit || 10}`
      ...
      +`${takeUrlCustomerLocalStorage.Trangthaikhoanvaycashloan ? `&Trangthaikhoanvaycashloan=${takeUrlCustomerLocalStorage.Trangthaikhoanvaycashloan}` : ''}`
      +`${takeUrlCustomerLocalStorage.Trangthaikhoanvaycreditline ? `&Trangthaikhoanvaycreditline=${takeUrlCustomerLocalStorage.Trangthaikhoanvaycreditline}` : ''}`
      ...
      +`${takeUrlCustomerLocalStorage.cashLoanApproveStartDate ? `&cashLoanApproveStartDate=${takeUrlCustomerLocalStorage.cashLoanApproveStartDate}` : ''}`
      ...
      +`${takeUrlCustomerLocalStorage.creditLineApproveStartDate ? `&creditLineApproveStartDate=${takeUrlCustomerLocalStorage.creditLineApproveStartDate}` : ''}`
      +`${takeUrlCustomerLocalStorage.creditLineApproveEndDate ? `&creditLineApproveEndDate=${takeUrlCustomerLocalStorage.creditLineApproveEndDate}` : ''}`
