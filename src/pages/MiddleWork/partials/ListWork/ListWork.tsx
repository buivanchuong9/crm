...
export default function ListWork(props: any) {
  ...
  const dataMappingArray = (item: any, index: number, type?: string) =>
    type !== "export"
      ...
      : [
          ...
          // item.priorityLevel === 4 ? 'Công việc gấp' : item.priorityLevel === 3 ? 'Công việc ưu tiên' : 'Công việc không ưu tiên',
          // item.departmentName,
  ...
  // useOnClickOutside(refFilter, () => setIsShowFilter(false), ["container_filter"]);
      ...
      <div className="card-box d-flex flex-column">
        <div className="action-header">
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <div>
              <TitleAction title="" titleActions={titleActions} disableIcon={true} />
            </div>
          </div>
