...
import InProgress, { Step } from "pages/Common/InProgress";
...
export default function MiddleWorkList() {
  ...
  const steps: Step[] = [
    {
      step: 1,
      status: "done", // Giá trị hợp lệ
      stepName: "Khởi tạo",
    },
    {
      step: 2,
      status: "done", // Giá trị hợp lệ
      stepName: "Tham gia thầu Tham gia thầu Tham gia thầu",
    },
    {
      step: 3,
      status: "in_progress", // Giá trị hợp lệ
      stepName: "Thương thảo",
    },
    {
      step: 4,
      status: "pending", // Giá trị hợp lệ
      stepName: "Kết quả dự thầu",
    },
    {
      step: 5,
      status: "pending", // Giá trị hợp lệ
    ...
    {
      step: 6,
      status: "cancel", // Giá trị hợp lệ
      stepName: "Bị huỷ",
    },
  ];

  return (
    <div className="page-content page-middle-work card-box">
      <div className="actions-title">
        {<TitleAction title={isDetailWork || isHandleTask ? "Công việc" : "Danh sách công việc"} titleActions={titleActions} />}
      </div>
      {/* <InProgress listStepProcess={steps} type={"bidv"} /> */}
      {type == "project" ? (
