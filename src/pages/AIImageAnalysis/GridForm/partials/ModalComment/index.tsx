...
import ImageAvatar from "assets/images/avatar-male.jpg";
import "./index.scss";
                          ...
                          {item?.isReply ? (
                            <div className="input-container-reply">
                              <div className="input-area">
                                ...
                                >
                                  {loadingSave ? <Icon name="Loading" /> : <Icon name="ArrowSmallUp" />}
                                </div>
                              </div>
                            </div>
                          ) : null}
                                      ...
                                      <div className="input-area">
                                        ...
                                        <div
                                          ...
                                          onClick={() => {
                                            if (!loadingSave) {
                                              setLoadingSave(true);
                                              handleSubmitNewComment(item.id, dataComment[index].childrent[indexChild].replyContent, index, child.id);
                                            }
                                          }}
                                        >
                                          {loadingSave ? <Icon name="Loading" /> : <Icon name="ArrowSmallUp" />}
