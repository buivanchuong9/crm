...
import TopProcessUsed from "./partials/TopProcessUsed";
import UsedProcessProportion from "./partials/UsedProcessProportion";
import AdvancedDateFilter from "components/advancedDateFilter/advancedDateFilter";
import {ProcessUsageTrend} from "./partials/ProcessUsageTrend";
import "./MostUsedProcessReport.scss";
import DataTable from "./partials/DataTable";
import Icon from "components/icon";
import Input from "components/input/input";

export default function MostUsedProcessReport() {
  document.title = "Báo cáo quy trình sử dụng nhiều nhất";
        ...
        <Fragment>
          ...
          <div className="box__merge--campaign">
            <div className="chart__pie">
              <UsedProcessProportion paramsProps={params} />
            </div>
            <div className="chart__top">
              <TopProcessUsed paramsProps={params} />
            </div>
          </div>
          <div>
              <ProcessUsageTrend params={params} />
          </div>
          <div>
            <DataTable />
          </div>
