...
export const ProcessingTrend = ({ params }) => {
  const chartOptions = {
    yAxis: {
      title: {
        text: "Số lượng hồ sơ",
  ...
  return (
    <Fragment>
      <HighChart title="Xu hướng số lượng xử lý theo thời gian (theo tuần/tháng)" defaultType="line" allowTypeChange chartOptions={chartOptions} />
    </Fragment>
  );
};
