...
export const BottleneckError = ({ params }) => {
  ...
  return (
    <Fragment>
      <HighChart title="Thống kê các System Task bị lỗi nhiều nhất" defaultType="pie" allowTypeChange={false} chartOptions={chartOptions} />
    </Fragment>
  );
};
