...
export const BottleneckMax = ({ params }) => {
  const chartOptions = {
    xAxis: {
  ...
  return (
    <Fragment>
      <HighChart title="Thống kê top 10 bước chiếm nhiều thời gian nhất" defaultType="bar" allowTypeChange chartOptions={chartOptions} />
    </Fragment>
  );
};
