...
import "./ReportBottleneck.scss";
import { BottleneckError } from "./partials/BottleneckError";
import { BottleneckMax } from "./partials/BottleneckMax";
      ...
      <Fragment>
        ...
        <div className="chart-layout_wrapper">
          <div className="chart__smaller chart-1">
            <BottleneckMax params={params} />
          </div>
          <div className="chart__bigger chart-2">
            <BottleneckError params={params} />
          </div>
        </div>
      </Fragment>
    </div>
