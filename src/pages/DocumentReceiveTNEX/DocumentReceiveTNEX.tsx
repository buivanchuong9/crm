...
import "./DocumentReceiveTNEX.scss";
...
import ModalAddDocumentTNEX from "./ModalAddDocumentTNEX/ModalAddDocumentTNEX";

export default function DocumentReceiveTNEX(props: any) {
  ...
  const titles = ["STT", "Số văn bản đến", "Tên văn bản", "Loại văn bản", "Trạng thái", "Bước quy trình"];
