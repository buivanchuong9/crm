...
import "./ModalAddDocumentTNEX.scss";
...
export default function ModalAddDocumentTNEX({ onShow, onHide, dataProcurement }) {
    ...
    const onSubmit = async (config) => {
      ...
      if (response.code === 0) {
        showToast(`Tạo văn bản đến thành công`, "success");
        setTimeout(() => {
          handleClear(true); 
        }, 1000)
