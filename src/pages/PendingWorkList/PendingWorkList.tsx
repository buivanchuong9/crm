...
import "./PendingWorkList.scss";
import HandleTask from "pages/MiddleWork/partials/ListWork/partials/HandleTask/HandleTask";
import ListPendingWork from "./ListPendingWork/ListPendingWork";

export default function PendingWorkList() {
...
//   const [isRegimeKanban, setIsRegimeKanban] = useState<boolean>(false);
  ...
  document.title = `${isDetailWork ? "Chi tiết công việc" :  "Công việc chưa thực hiện"}`;
  ...
  return (
    <div className="page-content page-pending-work card-box">
        <div className="actions-title">{<TitleAction title={(isDetailWork || isHandleTask) ? 'Công việc' : "Công việc chưa thực hiện"} titleActions={titleActions} />}</div>
