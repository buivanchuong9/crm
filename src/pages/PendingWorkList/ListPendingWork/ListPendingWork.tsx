...
export default function ListPendingWork(props: IListWorkProps) {
  ...
  const [listSaveSearch] = useState<ISaveSearch[]>([
    {
      key: "all",
      name: "Danh sách công việc chưa thực hiện",
      is_active: true,
    },
  ]);
  ...
  return (
    <div className={`page-content page-pending-work-list${isNoItem ? " bg-white" : ""}`}>
