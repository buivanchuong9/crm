...
import "./ModalSignalEndEvent.scss";
...
export default function ModalSignalEndEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    const response = await BusinessProcessService.detailSignalEndEvent(id);
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-signal-end-event"
      >
