...
import "./ModalSignalStartEvent.scss";
...
export default function ModalSignalStartEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    const response = await BusinessProcessService.detailSignalStartEvent(id);
    ...
    if (response.code == 0) {
      ...
      if (result?.messageId) {
        ...
        const prefix = "bpm-signal-message-";
  ...
  const onSubmit = async (e) => {
    ...
    const body = {
      ...
      messageName: data?.messageName ?? "",
      messageId: `bpm-signal-message-${formData?.messageId}` ?? "",
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-signal-start-event"
      >
        <form className="form-signal-start-event" onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="list-form-group">
              ...
              <div className="form-group" style={{ width: "100%" }}>
                ...
                <div className="box-input-message">
                  <span style={{ fontSize: 14, fontWeight: "400" }}>bpm-signal-message-</span>
                  <Input
                    name="messageId"
