...
const BusinessProcessCreate = () => {
  const safeParseLocalStorage = <T,>(value: string | null, fallback: T): T => {
  ...
  const takeUrlProcessLocalStorage = safeParseLocalStorage<{ page?: number; name?: string }>(
    localStorage.getItem("backUpUrlProcess"),
    {}
  );
