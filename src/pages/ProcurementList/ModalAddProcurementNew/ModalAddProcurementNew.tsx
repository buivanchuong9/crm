...
import "./ModalAddProcurementNew.scss";
...
export default function ModalAddProcurementNew({ onShow, onHide, workId }) {
    ...
    const handleSchemaSubmit = (newSchema, errorFields) => {
        ...
        <form className="form-handle-task" onSubmit={(e) => onSubmit(e)}>
          ...
          <ModalBody>
            <div className='container_handle_task-modal'>
                ...
                {(!dataEngine || dataEngine?.isReceived === 1 || dataEngine?.isProcessed === 1 || isLoadingEngine || isLoading || initFormSchema?.components?.length === 0 )  ? null :
