...
import AddTreatmentScheduleModal from "pages/ClinicCalendar/partials/AddTreatmentScheduleModal/AddTreatmentScheduleModal";
...
interface IParamsCustomerInDoctorQnA {
  keyword?: string;
  callStatus?: string;
  startDate?: string;
  endDate?: string;
...
export default function CustomerList(props: ICustomerListProps) {
  ...
  const [params, setParams] = useState<IParamsCustomerInDoctorQnA>({
    keyword: "",
  });
