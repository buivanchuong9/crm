...
export default function ClinicInfoList() {
  ...
  document.title = t(`pageClinicInfo.title`);
  ...
  const menuCategorySMS = [
    {
      title: t(`pageClinicInfo.listBranches`),
      is_tab: "tab_one",
    },
    {
      title: t(`pageClinicInfo.listDepartments`),
      is_tab: "tab_two",
    },
    {
      title: t(`pageClinicInfo.listRole`),
      is_tab: "tab_six",
    },
    {
      title: t(`pageClinicInfo.listEmployee`),
      is_tab: "tab_three",
    },
    {
      title: t(`pageClinicInfo.listTeam`),
      is_tab: "tab_five",
    },
    ...(isBeauty && isBeauty == "1"
      ? [
          {
            title: t(`pageClinicInfo.listTreatmentRooms`),
            is_tab: "tab_four",
          },
        ]
      : []),
  ...
  return (
    <div className="page-content page-setting-basis">
      {!isDetailCategory && <h1>{t(`pageClinicInfo.title`)}</h1>}
