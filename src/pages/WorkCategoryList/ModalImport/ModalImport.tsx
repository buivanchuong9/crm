...
export default function ModalImport(props: any) {
  ...
  const onSubmit = async () => {
    // e.preventDefault();
    setIsSubmit(true);
    uploadDocumentFormData(addFile, onSuccessPurchase, onError, onProgressPurchase, 'workCategory');
    // setIsSubmit(true);
