...
import "./DailyProgressLogList.scss";
import OptManagementList from "./partials/OptManagement/OptManagementList";

export default function DailyProgressLogList() {
  ...
  document.title = `${isDetailWork ? "Chi tiết công việc" : isRegimeKanban ? "Kanban công việc" : "Nhật ký tiến triển (Nơi up ảnh vết thương hàng ngày)"}`;
