...
import "./ProcurementListTNEX.scss";
...
import BoxTable from "pages/ProcurementList/BoxTable/BoxTable";
import ModalAddProcurementNew from "./ModalAddProcurementNewTNEX/ModalAddProcurementNewTNEX";

export default function ProcurementListTNEX(props: any) {
  ...
  const titles = ["STT", "Mã YCMS", "", "Tên yêu cầu mua sắm", "Loại yêu cầu mua sắm", "Lĩnh vực", "Dự án", "Trạng thái", "Bộ phận yêu cầu", "Bước quy trình"];
  ...
  const showDialogConfirmDelete = (item?: any) => {
    const contentDialog: IContentDialog = {
      ...
      message: (
        <Fragment>
          Bạn có chắc chắn muốn xóa {item ? "yêu cầu mua sắm/ tờ trình chủ trương " : `${listIdChecked.length} yêu cầu mua sắm/ tờ trình chủ trương đã chọn`}
  ...
  return (
    <div className="page-content page-procurement-list-TNEX card-box">
        <TitleAction title="Mua sắm đầu tư" />
