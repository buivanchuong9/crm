...
import AddCustomerCompanyModal from "pages/PatientRecord/partials/AddCustomerCompanyModal";

const ModalAddPartner = () => null;
...
export default function DetailPatientCase() {
  document.title = "Chi tiết ca bệnh";
    ...
    <div className="page-content page-detail-project">
      <div className="action-navigation">
        <div className="action-backup">
          ...
          <h1 className="title-last">Chi tiết ca bệnh</h1>
        </div>
      </div>
