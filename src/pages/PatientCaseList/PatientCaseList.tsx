...
import AddProjectManagementModal from "pages/DailyProgressLog/partials/ProjectManagement/partials/AddProjectManagementModal";
...
export default function PatientCaseList() {
  ...
  document.title = `${"Danh sách ca bệnh"}`;
