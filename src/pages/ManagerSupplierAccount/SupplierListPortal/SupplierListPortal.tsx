...
import "./SupplierListPortal.scss";
...
export default function SupplierListPortal(props: any) {
  ...
  const titles = ["STT", "Email/Tên đăng nhập", "Tên người liên hệ", "Tên nhà thầu", "Đã đăng ký"
    // ...(dataInfoEmployee?.isOwner === 1 ? ["Hoạt động"] : [])
  ];
  ...
  const actionsTable = (item: any): IAction[] => {
    return [
      ...(item.satId ? [] : [
        ...
        {
          title: listIdChecked.length > 0 ? "" : "Kích hoạt tài khoản",
  ...
  return (
    <div className="page-suppiler-list-portal">
          ...
          <Fragment>
            {isPermissions ? (
              ...
              <SystemNotification
                description={
                  <span>
                    Hiện tại chưa có thông tin đăng ký nào. <br />
