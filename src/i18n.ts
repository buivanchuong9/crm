    ...
    en: {
      translation: {
        ...
        sidebar: {
          ...
          cashbook: "Cash book",
          bpmModule: "Clinical Workflow",
          bpm: "Process Management",
          manageProcesses: "Clinical workflow templates",
          manageDefaultProcesses: "Default clinical protocols",
          business_rule: "Clinical rules",
          processSimulation: "Clinical workflow simulation",
          objectManage: "Patient case management",
          taskAssignment: "Assign clinical tasks",
          pendingTasks: "Waiting clinical tasks",
          completedTasks: "Completed clinical tasks",
          taskPrioritization: "Clinical task priorities",
    ...
    vi: {
      translation: {
        ...
        sidebar: {
          ...
          cashbook: "Tài chính",
          bpmModule: "Quy trình khám chữa bệnh",
          bpm: "Quy trình lâm sàng",
          manageProcesses: "Mẫu quy trình điều trị",
          manageDefaultProcesses: "Phác đồ mặc định",
          business_rule: "Luật xử lý y khoa",
          processSimulation: "Mô phỏng luồng điều trị",
          objectManage: "Quản lý hồ sơ bệnh án",
          taskAssignment: "Phân công xử lý ca",
          pendingTasks: "Ca bệnh chờ xử lý",
          completedTasks: "Ca bệnh đã hoàn thành",
          taskPrioritization: "Ưu tiên xử lý ca",
