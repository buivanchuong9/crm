...
import { convertToFileName, getSearchParameters } from "reborn-util";
...
import ActionRow from "./partials/ActionRow/ActionRow";
import SelectLookup from "./partials/SelectLookup/SelectLookup";
import ModalExport from "pages/BPM/GridForm/partials/ModalExport/ModalExport";
import ModalImport from "pages/BPM/GridForm/partials/ModalImport";
...
export default function GridData(props: any) {
  ...
  const { dataGrid, dataHeader, onHide, onChange } = props;
  ...
  }, [listColumn]); // Chỉ chạy khi listColumn.length thay đổi (thêm hoặc xóa cột)
    ...
    for (const element of dataExcel.slice(lineStart)) {
      ...
      for (let field of _baseRow) {
        ...
        if (field.type == "binding" && element[field.name]) {
          ...
          if (field.lookup == "material" || field.lookup == "unit") {
  ...
  return (
    <div className="box__add-grid-data">
      <div className="form-group">
        ...
        {dataRow.length > 0 ? (
          <div className="content__tbody--table">
            <div className="wrap-table" style={{ borderBottomRightRadius: "0" }}>
                        ...
                        return rowIndex == 0 ? ( // Hàng đầu tiên là tiêu đề
                          ...
                          <div
                            ...
                            style={{ 
                                ...
                                backgroundColor: field.disabled ?  '#F8F8F8' : ''
                            }}
                          >
                            {/* {enableAddCmtCell ? (
                              <div
