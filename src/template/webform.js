(function () {
  ...
  function getCustomer(formBody) {
    ...
    t.open("POST", "https://cloud.DermaHealth.vn/adminapi/customer/update/webform", true);
  ...
  //   t.open("POST", "https://cloud.DermaHealth.vn/adminapi/contact/update/webform", true);
