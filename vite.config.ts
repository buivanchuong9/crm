...
export default defineConfig(({ mode }) => {
  ...
  return {
    // Keep Vite cache outside node_modules to avoid stale/missing optimized deps artifacts
    // when node_modules is cleaned or partially updated.
    cacheDir: ".vite",
    ...
    optimizeDeps: {
      // Force a clean re-optimize on dev startup to avoid "file does not exist" errors
      // from stale optimizeDeps manifests.
